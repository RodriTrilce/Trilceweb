  ...
  <style>
    * {
    ...
    #table-rest.table-rest tr:nth-child(1) {
  ...
  <script>
    ...
    xhr.onload = function() {
      ...
      if (xhr.readyState == 4 && xhr.status == "200") {
        ...
        var tr = "";
        var tableend = "</table>";
        var SERVICIO, SERVICIO_DESCRIPCION, NIVEL_ESTUDIO_DESCRIPCION, BLDG_DESCRIPCION, FECHA_INICIO, FECHA_FIN, PAGO_CONTADO, PAGO_CUOTA1, PAGO_CUOTA2, PAGO_CUOTA3, PAGO_CUOTA4, PAGO_MENSUAL, HORARIO_SEMANAL1, TURNO;
