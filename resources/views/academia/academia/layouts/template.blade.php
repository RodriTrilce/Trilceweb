...
<head>
  ...
  <link rel="stylesheet" href="{{ mix('/css/main.css') }}?v1.7">
  <link rel="stylesheet" href="{{ mix('/css/main_academia.css') }}?v1.7">
...
<script src="{{ mix('/js/app_academia.js') }}?v1.5" charset="utf-8"></script>
