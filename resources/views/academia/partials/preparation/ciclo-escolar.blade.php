...
<div class="row col-xs-12 center-xs container-base frequentquestions">
    ...
    <div class="main">
        ...
        <label for="tab2">SEMESTRAL - MAÑANA
            <!--div class="tab_subtitle">Incorporaciones al 27 de abril</div--></label>

        <input id="tab1" type="radio" name="tabs" checked>
        <label for="tab1">PRIMERA OPCIÓN - TARDE
            <!--div class="tab_subtitle">Incorporaciones al 11 de mayo</div--></label>
            ...
            <div class="row col-xs-12 center-xs">
                <div class="row col-xs-12 start-sm preparation__courses">
                    ...
                    <div class="col-sm-6 xs-hide">
                        <img src="/static/images/academia/preparacion/pucp-1-cursos.png" class="preparation__item-image"
                            alt="">
                    </div>
                </div>
            </div>
