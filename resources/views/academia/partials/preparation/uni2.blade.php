<head>
   <title>Academia Trilce | Preparación para examen de admisión de la UNI</title>
   <meta name="title" content="Academia Trilce | Preparación para examen de admisión de la UNI" />
   <meta property="og:title" content="Academia Trilce | Preparación para examen de admisión de la UNI" />
   <meta name="twitter:title" content="Academia Trilce | Preparación para examen de admisión de la UNI" />
   <meta name="description" content="Preparación para el examen de admisión de la Universidad Nacional de Ingeniería (UNI)." />
   <meta property="og:description" content="Preparación para el examen de admisión de la Universidad Nacional de Ingeniería (UNI)." />
   <meta name="twitter:description" content="Preparación para el examen de admisión de la Universidad Nacional de Ingeniería (UNI)." />
...
.benefits-container {
  ...
  align-items: end; /* Centra los elementos verticalmente */
...
h1.preparation__title.titulo_conoce {
    width: 100%;
    height: 30%;
}
...
@media(min-width: 992px) 
{
   ...
   #table-rest3.table-2 tr:nth-child(1) th {
      border-bottom: 1px solid rgba(0, 0, 0, 0.50) !important;
      position: relative;
   }
   .table-rest3 thead tr th {
      border-bottom: 1px solid #53565a;
   }
   .table-rest3 tbody tr:nth-child(1) td {
      padding-top: 2em;
   }
   .table-rest3 tr th {
   }
   ...
   #table-rest4.table-2 tr:nth-child(1) th {
      border-bottom: 1px solid rgba(0, 0, 0, 0.50) !important;
      position: relative;
   }
   .table-rest4 thead tr th {
      border-bottom: 1px solid #53565a;
   }
   .table-rest4 tbody tr:nth-child(1) td {
      padding-top: 2em;
   }
   .table-rest4 tr th {
   }
   ...
   #table-rest5.table-2 tr:nth-child(1) th {
      border-bottom: 1px solid rgba(0, 0, 0, 0.50) !important;
      position: relative;
   }
   .table-rest5 thead tr th {
      border-bottom: 1px solid #53565a;
   }
   .table-rest5 tbody tr:nth-child(1) td {
      padding-top: 2em;
   }
   .table-rest5 tr th {
   }
...
@media (max-width: 991px) 
{
   ...
   .table-rest3 tbody tr td:nth-child(1) {
      font-weight: bold;
   }
   .table-rest3 thead tr {
      position: absolute;
      top: -9999px;
      left: -9999px;
      font-weight: bold;
   ...
   .table-rest3 tr:nth-child(2),
   .table-rest3 tr:nth-child(4),
   .table-rest3 tr:nth-child(6),
   .table-rest3 tr:nth-child(8),
   .table-rest3 tr:nth-child(10),
   .table-rest3 tr:nth-child(12),
   .table-rest3 tr:nth-child(14),
   .table-rest3 tr:nth-child(16),
   .table-rest3 tr:nth-child(18),
   .table-rest3 tr:nth-child(20) {
      background: #f5f5f5;
   }
   .table-rest3 td {
      /* Behave  like a "row" */
   ...
   .table-rest3 td:nth-of-type(1):before {
      content: "Inicio";
      font-weight: bold;
   }
   .table-rest3 td:nth-of-type(2):before {
      content: "Fin";
   }
   .table-rest3 td:nth-of-type(3):before {
      content: "N° Semanas";
   }
   .table-rest3 td:nth-of-type(4):before {
      content: "Precio Mensual";
   }
	.table-rest3 td:nth-of-type(5):before {
      content: "Precio Mensual (Virtual)";
   }
   .table-rest3 td:nth-of-type(6):before {
      content: "Turno";
   }
   .tab-sup .table-rest3 tr {
      padding: 1em !important;
   }
   /* fin tr3 */
   ...
   .table-rest4 tbody tr td:nth-child(1) {
      font-weight: bold;
   }
   .table-rest4 thead tr {
      position: absolute;
      top: -9999px;
      left: -9999px;
      font-weight: bold;
   ...
   .table-rest4 tr:nth-child(2),
   .table-rest4 tr:nth-child(4),
   .table-rest4 tr:nth-child(6),
   .table-rest4 tr:nth-child(8),
   .table-rest4 tr:nth-child(10),
   .table-rest4 tr:nth-child(12),
   .table-rest4 tr:nth-child(14),
   .table-rest4 tr:nth-child(16),
   .table-rest4 tr:nth-child(18),
   .table-rest4 tr:nth-child(20) {
      background: #f5f5f5;
   }
   .table-rest4 td {
      /* Behave  like a "row" */
   ...
   .table-rest4 td:nth-of-type(1):before {
      content: "Inicio";
      font-weight: bold;
   }
   .table-rest4 td:nth-of-type(2):before {
      content: "Fin";
   }
   .table-rest4 td:nth-of-type(3):before {
      content: "N° Semanas";
   }
	.table-rest4 td:nth-of-type(4):before {
      content: "Precio Mensual";
   }
   .table-rest4 td:nth-of-type(5):before {
      content: "Turno";
   }
   .tab-sup .table-rest4 tr {
      padding: 1em !important;
   }
   /* fin tr4 */
   ...
   .table-rest5 tbody tr td:nth-child(1) {
      font-weight: bold;
   }
   .table-rest5 thead tr {
      position: absolute;
      top: -9999px;
      left: -9999px;
      font-weight: bold;
   ...
   .table-rest5 tr:nth-child(2),
   .table-rest5 tr:nth-child(4),
   .table-rest5 tr:nth-child(6),
   .table-rest5 tr:nth-child(8),
   .table-rest5 tr:nth-child(10),
   .table-rest5 tr:nth-child(12),
   .table-rest5 tr:nth-child(14),
   .table-rest5 tr:nth-child(16),
   .table-rest5 tr:nth-child(18),
   .table-rest5 tr:nth-child(20) {
      background: #f5f5f5;
   }
   .table-rest5 td {
      /* Behave  like a "row" */
   ...
   .table-rest5 td:nth-of-type(1):before {
      content: "Inicio";
      font-weight: bold;
   }
   .table-rest5 td:nth-of-type(2):before {
      content: "Fin";
   }
   .table-rest5 td:nth-of-type(3):before {
      content: "N° Semanas";
   }
	.table-rest5 td:nth-of-type(4):before {
      content: "Pago al contado";
   }
   .table-rest5 td:nth-of-type(5):before {
      content: "Cuota 1";
   }
   .table-rest5 td:nth-of-type(6):before {
      content: "Cuota 2";
   }
   .table-rest5 td:nth-of-type(7):before {
      content: "Modalidad";
   }
   .table-rest5 td:nth-of-type(8):before {
      content: "Sedes";
   }
   .tab-sup .table-rest tr {
      padding: 1em !important;
...
.margin-texto
   ...
   #tab_5:checked~#content_6,
   #tab_5:checked~#content_7, 
...
<body>
   <div class="row col-xs-12 left-xs container-base frequentquestions">
      <div class="margin-texto">
         <p>&nbsp;</p>
         <h2 style="color: #333; font-weight: bold; font-family: Geogrotesque-Rg;">Preparación para el examen de admisión de la Universidad Nacional de Ingeniería (UNI)</h2>
         <p>&nbsp;</p>
         <p>Trilce es líder en la preparación preuniversitaria para estudiantes que terminaron el colegio o aún estén cursando sus últimos años de formación. Nuestra experiencia te guiará hacia el éxito en el examen de admisión de la Universidad Nacional de Ingeniería (UNI).</p>
      </div>
   </div>
...
<div class="row col-xs-12 center-xs container-base frequentquestions">
   <div class="main tab-sup">
      ...
      <div class="content">
         ...
         <div id="content2">
            <table class="table-rest4 animate__animated animate__fadeIn">
               <thead>
                  <tr>
                     <th>Inicio</th>
			            <th>Fin</th>
            ...
            <table class="table-rest5 animate__animated animate__fadeIn">
               ...
               <tbody>
                  <tr>
                     ...
                     <td>S/ 420.00</td>
                     <td>Mañana</td>
                     <td>Santa Beatriz y Los Olivos</td>
                  </tr>
               </tbody>
            </table>
         </div>
            ...
            <table class="table-rest animate__animated animate__fadeIn">
                  <thead>
                     <tr>
                        <th>Inicio</th>
			               <th>Fin</th>
			               <th>Pago mensual <br>(Presencial)</th>
                  ...
                  <tbody>
                     <tr>
			               ...
			               <td>S/ 390.00</td>
			               <td>S/ 180.00</td>
      			         <td class="texto-horario">Mañana</td>
                     </tr>
                     <tr>
      			         <td>28/08/2023</td>
      			         <td>23/12/2023</td>
            ...
            <table class="table-rest animate__animated animate__fadeIn">
                  ...
                  <tbody>
                     <tr>
				            ...
				            <td>S/ 260.00</td>
				            <td>S/ 120.00</td>
      				      <td class="texto-horario">Tarde</td>
                     </tr>
                     <tr>
				            <td>11/09/2023</td>
      				      <td>02/12/2023</td>
               ...
               <div class="row col-xs-12 start-sm preparation__courses">
                  <div class="col-xs-12 col-sm-6 preparation__courses-list animate__animated animate__fadeIn">
                        <div class="col-xs-12 col-sm-6 preparation__courses-list">
							...
							<strong>Cursos académicos</strong>
							<br><br>
							...
							<strong>Cursos de desarrollo y orientación al postulante</strong>
							<br><br>
							<ul class="preparation__list-ul preparation__courses-list-ul ul-li-squared">
								<li>Tutoría.</li>
						...
						<!--div class="col-xs-12 -col-sm-12 col-md-12"><br><br>
							<h1 class="sub-title"><strong>Escolar</strong></h1>
							<strong>Cursos académicos</strong>
							<br><br>
							<ul class="preparation__list-ul preparation__courses-list-ul ul-li-squared">
								<li>Aritmética.</li>
         ...
         <div class="row col-xs-12 center-xs">
            <div class="row col-xs-12 start-sm preparation__cicles animate__animated animate__fadeIn">
				<div class="col-xs-12 col-sm-6 preparation__cicles__section">
					<!--p>
						<h1 class="sub-title"><strong>Anual</strong></h1>
						Dirigido a estudiantes que están cursando sus últimos grados de estudios escolares y/o acabaron 5to año de secundaria y que desean ingresar a la universidad en un próximo examen de admisión.<br>
						...
						<ul class="preparation__list-ul ul-li-squared">
							<li>39 semanas, considerando el primer inicio 15 de marzo.</li>
						</ul>
					</p-->
					<p>
						<h1 class="sub-title"><strong>Semestral II - Mañana</strong></h1>
						Dirigido a estudiantes que terminaron 5to año de secundaria con preparación previa, interesados en postular la universidad en un próximo examen de admisión.<br>
						<strong class="mt-2">Nivel de trabajo en clase</strong>
						<ul class="preparation__list-ul ul-li-squared">
						...
						<strong class="mt-2">Duración</strong>
						<ul class="preparation__list-ul ul-li-squared">
							<li>18 semanas, considerando el primer inicio 16 de agosto.</li>
						</ul>
					</p>
					<p>
						<h1 class="sub-title"><strong>Semestral II - Tarde</strong></h1>
						Dirigido a estudiantes que terminaron 5to año de secundaria con preparación previa, interesados en postular la universidad en un próximo examen de admisión.<br>
						<strong class="mt-2">Nivel de trabajo en clase</strong>
						<ul class="preparation__list-ul ul-li-squared">
							<li>30% teoría y 70% práctica.</li>
						...
						<strong class="mt-2">Duración</strong>
						<ul class="preparation__list-ul ul-li-squared">
							<li>16 semanas, considerando el primer inicio 16 de agosto.</li>
						</ul>
					</p>
					<!--p>
						<h1 class="sub-title"><strong>Escolar</strong></h1>
						A los estudiantes que cursan 5to año de secundaria interesados en postular en la modalidad examen escolar que ofrece está casa de estudios.
						<br>
						<strong class="mt-2">Nivel de trabajo en clase</strong>
						<ul class="preparation__list-ul ul-li-squared">
							<li>50% teoría y 50% práctica.</li>
						...
						<strong class="mt-2">Duración</strong>
						<ul class="preparation__list-ul ul-li-squared">
							<li>18 semanas, considerando el primer inicio 29 de marzo.</li>
						</ul>
					</p-->
				</div>
				<div class="col-sm-6 xs-hide">
            ...
            <div class="row col-xs-12 start-sm preparation__courses">
               <div class="col-xs-12 col-sm-6 preparation__courses-list animate__animated animate__fadeIn">
                  <!--h1 class="sub-title"><strong>Anual</strong></h1>
						...
						<ul class="preparation__list-ul ul-li-squared">
							<li>Guías y prácticas para cada sesión.</li>
							<li>Simulacros tipo admisión. (03 exámenes en el ciclo).</li>
						...
						<ul class="preparation__list-ul ul-li-squared">
							<li>Guías y prácticas para cada sesión.</li>
							<li>Simulacros tipo admisión. (02 exámenes en el ciclo).</li>
							<li>Exámenes semanales.</li>
							<li>Videos grabados de cada clase para tu repaso constante.</li>
						</ul-->
               </div>
         ...
         <div class="row col-xs-12  center-xs">
               <div class="row col-xs-12 start-sm preparation__courses  animate__animated animate__fadeIn">
                  <!--div class="col-xs-12 col-sm-12 preparation__courses-list">
                     <img src="/static/images/uni_anual080221.png" class=""
                        alt="">
                  </div-->
                  <div class="col-xs-12 col-sm-12 preparation__courses-list">
                     <img src="/static/images/uni_semestral080221.png" class=""
                        alt="">
                  </div>
				  <div class="col-xs-12 col-sm-12 preparation__courses-list">
                     <img src="/static/images/uni_semestral080221_tarde.png" class=""
                        alt="">
                  </div>
				     <!--div class="col-xs-12 col-sm-12 preparation__courses-list">
                     <img src="/static/images/uni_escolar080221.png" class=""
                        alt="">
                  </div-->
               </div>
            </div>  
...
<script>
   ...
   const uni = getUserStorage();
   console.log("/*-----------------------------------------------")
   console.log("Variable UNI: ")
   console.table(uni)
   console.log("-----------------------------------------------*/")
   
   function filtro(filtro, selector) {
       const result = uni.ACAUN.filter(v => v.NIVEL_ESTUDIO_DESCRIPCION === filtro);
