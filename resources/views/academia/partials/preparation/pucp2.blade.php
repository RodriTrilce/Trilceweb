...
<body>
    <div class="row col-xs-12 left-xs container-base frequentquestions">
        <div class="margin-texto">
            ...
            <h2 style="color: #333; font-weight: bold; font-family: Geogrotesque-Rg;">Preparación para el examen de
                admisión de la Católica (PUCP)</h2>
            <p>&nbsp;</p>
            <p>Trilce es líder en la preparación preuniversitaria para estudiantes que terminaron el colegio o aún estén
                ...
                admisión de la Pontificia Universidad Católica del Perú (PUCP).</p>
        </div>
    </div>
  ...
  <label for="tab1">
   Semestral II
                    ...
                    <table class="table-rest3 animate__animated animate__fadeIn">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Fin:">05/07/2025</td>
                                <td data-label="Nro. Semanas:">19</td>
                                <td data-label="Pago único (Presencial):">---</td>
                                <td data-label="1ra cuota:">---</td>
                                <td data-label="2da cuota:">---</td>
                                <td data-label="Pago mensual (Virtual)">S/ 280.00</td>
                    ...
                    <table class="table-rest3 animate__animated animate__fadeIn">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td data-label="Nro. Semanas:">09</td>
                                <td data-label="Pago único (Presencial):">S/ 950.00</td>
                            ...
                            <tr>
                                ...
                                <td data-label="1ra cuota:">---</td>
                                <td data-label="2da cuota:">---</td>
                                <td data-label="Pago mensual (Virtual):">S/ 250.00</td>
                                <td data-label="Sedes:" class="texto-horario">---</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="benefits-container">
        <div class="benefits-left">
            ...
            <div class="benefits-buttons">
                <a href="https://www.trilce.edu.pe/l/brochure-semestral-pucp-2025" target="_blank"
                    class="btn">Descargar Brochure Semestral I</a>
                <a href="https://www.trilce.edu.pe/l/brochure-pop-pucp-2025" target="_blank" class="btn">Descargar
                    Brochure POP I</a>
            </div>
        </div>
    ...
    <div class="row col-xs-12 center-xs container-base trilce-benefits" style="display: block">
        <div class="tabs_wrap">
                    ...
                    <div class="row col-xs-12 start-sm preparation__cicles animate__animated animate__fadeIn">
                     ...
                     <p>
                        ...
                        secundaria.
                            ...
                            <h1 class="sub-title"><strong>Semestral II</strong></h1>
                            Dirigido a estudiantes que acabaron 5to año de secundaria que desean ingresar a la
                            universidad en un próximo examen de admisión.<br>
                            ...
                            <p>
                            <h1 class="sub-title"><strong>Primera Opción II</strong></h1>
                            Dirigido a estudiantes que cursan el 5to año de secundaria que desean ingresar a la
                            universidad en un próximo examen de admisión.<br>
                            <strong class="mt-2">Nivel de trabajo en clase</strong>
                            <ul class="preparation__list-ul ul-li-squared">
                ...
                <div class="row col-xs-12  center-xs">
                    <div class="row col-xs-12 start-sm preparation__courses  animate__animated animate__fadeIn">
                        <div class="col-xs-12 col-sm-12 preparation__courses-list">
                            <img src="/static/images/semestral_catolica_050221.png" class="" alt="">
                        </div>
                        <div class="col-xs-12 col-sm-12 preparation__courses-list">
                            <img src="/static/images/pop_catolica_050221.png" class="" alt="">
                        </div>
                    </div>
                </div>
            </div>
