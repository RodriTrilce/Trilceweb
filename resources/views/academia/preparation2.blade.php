  ...
  <div class="header-double-top new_banner">
    <div class="row">
      ...
      <a href="https://www.trilce.edu.pe/l/whatsapp-uni" target="_blank" style="width: 100%">
        <img src="/static/images/academia/banners/banner-uni-2025_11zon.webp" alt="Trilce" class="version_desktop" style="width: 100%"/>
        <img src="/static/images/academia/banners/banner-uni-2025-MOBILE_11zon.webp" alt="Trilce" class="version_mobile"/>
        <div class="col-xs-12 col-sm-12 header-double-content-top header-double-w-preparation-{{$type}}"></div>
      </a>
      @elseif($type == 'san-marcos')
      <a href="https://www.trilce.edu.pe/l/whatsapp-san-marcos" target="_blank" style="width: 100%">
        <img src="/static/images/academia/banners_2025_enero/banner-san-marcos-2025_2_11zon.webp" alt="Trilce" class="version_desktop" style="width: 100%"/>
        <img src="/static/images/academia/banners_2025_enero/banner-san-marcos-2025-MOBILE_3_11zon.webp" alt="Trilce" class="version_mobile"/>
        <div class="col-xs-12 col-sm-12 header-double-content-top header-double-w-preparation-{{$type}}"></div>
      </a>
      @elseif($type == 'pucp')
      <a href="https://www.trilce.edu.pe/l/whatsapp-catolica" target="_blank" style="width: 100%">
        <img src="/static/images/academia/banners/banner-catolica-2025_11zon.webp" alt="Trilce" class="version_desktop" style="width: 100%"/>
        <img src="/static/images/academia/banners/banner-catolica-2025-MOBILE_11zon.webp" alt="Trilce" class="version_mobile"/>
        <div class="col-xs-12 col-sm-12 header-double-content-top header-double-w-preparation-{{$type}}"></div>
      </a>
      @endif
