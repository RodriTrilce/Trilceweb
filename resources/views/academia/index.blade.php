...
.close.modern-close {
  ...
  width: 35px; /* Ajusta el tamaño del botón */
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <a target="_blank" href="https://www.trilce.edu.pe/academia/preparacion-uni">
                <img src="{{asset('static/images/academia/banners/banner-uni-home-2025_11zon.webp')}}" alt="UNI - Trilce">
            </a>
        </div>

    <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/academia/preparacion-san-marcos">
                <img src="{{asset('static/images/academia/banners_2025_enero/banner-san-marcos-home-2025_4_11zon.webp')}}" alt="San Marcos - Trilce">
            </a>
        </div>

        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/academia/preparacion-pucp">
                <img src="{{asset('static/images/academia/banners/banner-catolica-home-2025_11zon.webp')}}" alt="Cátolica - Trilce">
            </a>
        </div>
        ...
        <a target="_blank" href="https://www.trilce.edu.pe/matricula-linea-2025/">
            <img src="{{asset('static/images/slides/banner-matricula-en-linea-1.png')}}" alt="Matrícula en línea - Trilce">
        </a>
        </div>

        <div class="carousel-item">
            <img src="{{asset('static/images/slides/banner-primer-puesto-pucp-computo-general-academia-2.png')}}" alt="Primer Puesto PUCP Cómputo General - Trilce">
        </div>


        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/l/whatsapp-ves">
                <img src="{{asset('static/images/academia/banners_2025_enero/banner-sede-ves_11zon.webp')}}" alt="Villa El Salvador - Trilce">
            </a>
        </div>

        <div class="carousel-item ">
            <img src="{{asset('static/images/slides/banner-clases-presenciales_2025_academias_trilce.webp')}}" alt="Clases Presenciales - Trilce">
        </div>

        <div class="carousel-item ">
            <img src="{{asset('static/images/slides/banner-clases-virtuales_3_2025_academias_trilce.webp')}}" alt="Clases Virtuales - Trilce">
        </div>
        ...
        <div class="carousel-item">
            <img src="{{asset('static/images/slides/banner-primer-puesto-PUCP-2024-1.png')}}" alt="Primer Puesto PUCP - Trilce">
        </div>   

        <div class="carousel-item">
            <img src="{{asset('static/images/slides/banner-45-anios-academia-2024.png')}}" alt="Banner 45 años - Trilce">
        </div>   

        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/l/whatsapp-academias">
                <img src="{{asset('static/images/academia/banners_2025_enero/banner-sedes-presenciales_2_11zon.webp')}}" alt="Academia sedes">
            </a>
        </div>

        <div class="carousel-item">
            <img src="{{asset('static/images/slides/1-banner-primer-puesto-SM-2024-2.png')}}" alt="Primer Puesto San Marcos - Trilce">
        </div>
        ...
        <div class="carousel-item">
            <img src="{{asset('static/images/slides/primer-puesto-UNI-2024-2.png')}}" alt="Primer Puesto UNI - Trilce">
        </div>

        <div class="carousel-item">
            <img src="{{asset('static/images/slides/banner-primeros-puestos-acad2.png')}}" alt="Primeros Puestos - Trilce">
        </div>
        ...
        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/academia/solucionarios">
                <img src="{{asset('static/images/slides/banner-solucionarios-2023.png')}}" alt="Solucionario - Trilce">
            </a>
        </div>
...
<div id="carouselTrilceAcademiaMovil" class="carousel mobile slide" data-ride="carousel" data-interval="5000">
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <a target="_blank" href="https://www.trilce.edu.pe/academia/preparacion-uni">
                <img src="{{asset('static/images/academia/banners/banner-uni-home-2025-MOBILE_11zon.webp')}}" alt="UNI - Trilce">
            </a>
        </div>

        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/academia/preparacion-san-marcos">
                <img src="{{asset('static/images/academia/banners_2025_enero/banner-san-marcos-home-2025-MOBILE_1_11zon.webp')}}" alt="San Marcos - Trilce">
            </a>
        </div>

        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/academia/preparacion-pucp">
                <img src="{{asset('static/images/academia/banners/banner-catolica-home-2025-MOBILE_11zon.webp')}}" alt="Cátolica - Trilce">
            </a>
        </div>
        ...
        <div class="carousel-item">
        <a target="_blank" href="https://www.trilce.edu.pe/matricula-linea-2025/">
            <img src="{{asset('static/images/slides/banner-matricula-en-linea-1-MOBILE.png')}}" alt="Matrícula en línea - Trilce">
        </a>
        </div>


        <div class="carousel-item">
            <img src="{{asset('static/images/slides/banner-primer-puesto-pucp-computo-general-academia-2-MOBILE.png')}}" alt="Primer Puesto PUCP Cómputo General - Trilce">
        </div>
        

        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/l/whatsapp-ves">
                <img src="{{asset('static/images/academia/banners_2025_enero/banner-sede-ves-MOBILE_11zon.webp')}}" alt="Villa El Salvador - Trilce">
            </a>
        </div>

        <div class="carousel-item ">
            <img src="{{asset('static/images/slides/banner-clases-presenciales-MOBILE_2025_academias_trilce.webp')}}" alt="Clases Presenciales - Trilce">
        </div>

        <div class="carousel-item ">
            <img src="{{asset('static/images/slides/banner-clases-virtuales-MOBILE_4_2025_academias_trilce.webp')}}" alt="Clases Virtuales - Trilce">
        </div>
        ...
        <div class="carousel-item ">
            <img src="{{asset('static/images/slides/banner-primer-puesto-PUCP-2024-1-MOBILE.png')}}" alt="Primer Puesto PUCP - Trilce">
        </div>

        <div class="carousel-item">
            <img src="{{asset('static/images/slides/banner-45-anios-academia-2024-MOBILE.png')}}" alt="Banner 45 años - Trilce">
        </div>   

        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/l/whatsapp-academias">
                <img src="{{asset('static/images/academia/banners_2025_enero/banner-sedes-presenciales-MOBILE_1_11zon.webp')}}" alt="Trilce - 45 años">
            </a>
        </div>

        <div class="carousel-item">
            <img src="{{asset('static/images/slides/1-banner-primer-puesto-SM-2024-2-MOBILE.png')}}" alt="Primer Puesto San Marcos - Trilce">
        </div>
        ...
        <div class="carousel-item">
            <img src="{{asset('static/images/slides/primer-puesto-UNI-2024-2-MOBILE.png')}}" alt="Primer Puesto UNI - Trilce">
        </div>

        <div class="carousel-item">
            <img src="{{asset('static/images/slides/banner-primeros-puestos-acad2-MOBILE.png')}}" alt="Primeros Puestos - Trilce">
        </div>

        <div class="carousel-item">
            <a target="_blank" href="https://www.tiktok.com/@trilce.academia">
                <img src="{{asset('static/images/slides/3-banner-tiktok-acad-1-MOBILE.png')}}" alt="TikTok - Trilce">
            </a>
        </div>

        <div class="carousel-item">
            <a target="_blank" href="https://www.trilce.edu.pe/academia/solucionarios">
                <img src="{{asset('static/images/slides/banner-solucionarios-2023-MOBILE.png')}}" alt="Solucionarios - Trilce">
            </a>
        </div>

        <div class="carousel-item">
            <img src="{{asset('static/images/slides/banner-medioambiente-movil.png')}}" alt="Medio Ambiente - Trilce">
        </div>
    ...
    <div class="row center-xs">
        <div class="col-xs-9 col-sm-11 col-md-10 start-xs nuevos-i-title">
            <div class="box">
                ...
                <p>Trilce es la academia preuniversitaria de elección, especializada en la preparación de estudiantes para los exámenes de admisión de universidades como San Marcos (UNMSM), la UNI y la Católica (PUCP), garantizando el éxito en su educación superior y en sus futuras carreras. Además, es importante destacar que nuestra preparación para San Marcos es igualmente válida para todas las universidades del Perú.</p>
                <br><br>
                <h2>Inicios</h2>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <a href="https://www.trilce.edu.pe/matricula-linea-2025/" target="_blank" class="modal-web-link">
          <img class="modal-web" src="{{ url('/static/images/modal-ciclos-2025.webp') }}" alt="Trilce - Web">
        </a>
        <!-- Imagen para móvil -->
        <a href="https://www.trilce.edu.pe/matricula-linea-2025/" target="_blank" class="modal-movil-link">
          <img class="modal-movil" src="{{ url('/static/images/modal-ciclos-2025.webp') }}" alt="Trilce - Móvil">
        </a>
      </div>
    </div>
  </div>
