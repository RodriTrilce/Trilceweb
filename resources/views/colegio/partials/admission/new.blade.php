<style>
    ...
    .colegio-cardsv2-items__item:nth-child(1) {
      border: 1px solid #f4633a;
    }

    .colegio-cardsv2-items__item:nth-child(1) i.fa-plus,
    .colegio-cardsv2-items__item:nth-child(1) span.alumno,
    .colegio-cardsv2-items__item:nth-child(1) span.modality {
    ...
    <div class="row col-xs-12 center-xs admission-new-title">
      ...
      <div class="tabs">
        <div class="tab-button-outer">
          <ul id="tab-button">
            <li><a href="#tab01">Inicial (5 años) y 1.° Primaria</a></li>
