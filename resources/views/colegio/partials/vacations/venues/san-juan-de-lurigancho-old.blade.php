...
<div class="col-xs-12 vacations__bottom vacations__bottom--white">
  <div class="table-responsive2" style="width:100%;">
    <table class="venue-table">
      ...
      <tbody>
        <tr>
          <td data-label="Nivel">Primaria (5.<sup>o</sup> y 6.<sup>o</sup> año) y secundaria</td>
          <td data-label="Dirección">Av. 13 de enero N<sup>o</sup> 1524, 1526 y 1528</td>
          <td data-label="Teléfono">984 290 467</td>
        </tr>
        <tr>
          <td data-label="Nivel">Primaria y secundaria</td>
          <td data-label="Dirección">Jr. El Rosario 530 urb. Canto Grande</td>
          <td data-label="Teléfono">2724 163</td>
        </tr>
      </tbody>
    </table>  
  </div>
