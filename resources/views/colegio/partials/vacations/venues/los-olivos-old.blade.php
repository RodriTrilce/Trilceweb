<div class="row container-new-tabs">
      ...
      <ul class="js-tabs__header">
        ...
        <li>
          <a href="#" class="js-tabs__title">
            <div>
              <svg version="1.1" class="vacations-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 800 800" enable-background="new 0 0 800 800" xml:space="preserve">
                <g>
                  <g>
        ...
        <li>
          ...
          <li>
            <a href="#" class="js-tabs__title">
              ...
              <div><span class="vacations-svg__title">Computación Primaria</span></div>
            </a>
          </li>
        ...
        <li>
          <a href="#" class="js-tabs__title">
            <div>
              <svg version="1.1" class="vacations-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 38 38" xml:space="preserve">
                <g>
                  <g>
                    <g>
        ...
        <li>
            <a href="#" class="js-tabs__title">
              ...
              <div><span class="vacations-svg__title">Computación Secundaria</span></div>
            </a>
          </li>
        ...
        <div class="row col-xs-12">
          <div class="col-md-12 col-xs-12">
            <ul class="ep-generic-list ep-generic-list--off">
              ...
              <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 1.<sup>er</sup>grado</h2>
                    <p><strong>Matemática, Comunicación, Razonamiento Matemático y Razonamiento Verbal.</strong></p>
                    <p>Lunes, miércoles y viernes de 8:45 a. m. a 12:30 p. m.</p>
                    <br>

                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 2º grado</h2>
                    <p><strong>Matemática, Comunicación, Razonamiento Matemático y Razonamiento Verbal.</strong></p>
                    <p>Lunes, miércoles y viernes de 8:45 a. m. - 12:30 m.</p>
                    <br>

                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 3 <sup>er</sup> grado</h2>
                    <p><strong>Matemática, Comunicación, Razonamiento Matemático y Razonamiento Verbal.</strong></p>
                    <p>Martes, jueves y viernes de 8:45 a. m. - 12:30 p. m.</p>
                    <br>

                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 4º grado</h2>
                    <p><strong>Matemática, Comunicación, Razonamiento Matemático y Razonamiento Verbal.</strong></p>
                    <p>Lunes, martes y jueves de 8:45 a. m. - 12:30 p. m.</p>
                    <br>

                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 5ª y 6º grado</h2>
                    <p><strong>Aritmética, Álgebra, Lenguaje, Raz. Matemático, Raz. Verbal y Elementos de Geometría.</strong></p>
                    <p>Martes, miércoles y Jueves de 8:45 a. m. - 12:30 p. m.</p>
                  <br>

              
                <!-- <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 1.<sup>er</sup> a 4.<sup>o</sup> grado
                </h2>
                <p><strong>Matemática, Comunicación, Razonamiento Matemático y Razonamiento Verbal.</strong></p>
                <p><strong>1.<sup>er</sup> y 2.<sup>o</sup> grado:</strong></p>
                <p>Lunes, miércoles y viernes de 8:45 a. m. a 12:30 p. m.</p>
                <br>
                <p><strong>3.<sup>er</sup> grado</strong></p>
                <p>Martes, jueves y viernes de 8:45 a. m. a 12:30 p. m.</p>
                <br>
                <p><strong>4.<sup>o</sup> grado</strong></p>
                <p>Lunes, martes y jueves de 8:45 a. m. a 12:30 p. m.</p>
                <br>
                <br>
                <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 5.<sup>o</sup> a 6.<sup>o</sup> grado
                </h2>
                <p><strong>Aritmética, Álgebra, Lenguaje, Razonamiento Matemático, Razonamiento Verbal y Elementos de Geometría.</strong></p>
                <p><strong>5.<sup>o</sup> y 6.<sup>o</sup> grado:</strong></p>
                <p>Martes, miércoles y jueves de 8:45 a. m. a 12:30 p. m.</p> -->
              </li>
              ...
              <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 180</span><br>
                    </li> 
                  </ul>
                </li>
            ...
            <div class="col-sm-12 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                <li>
                  ...
                  <p>
                    Martes y jueves de 8:15 a. m. a 10:45 a. m.
                  </p>
                  <br>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 3.<sup>er</sup></h2>
                  <p>
                    lunes y miércoles de 8:15 a. m. a 10:45 a. m.
                  </p>
                  <br>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 4.<sup>o</sup>grado</h2>
                  <p>
                    Miércoles y viernes de 11:00 a. m. a 1:30 p. m.
                  </p>
                  <br>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 5.<sup>o</sup> y 6.<sup>o</sup> grado</h2>
                  <p>
                    Lunes de 11:00 a. m. a 1:30 p. m.
                  </p>
                  <p>
                    Viernes de 8:15 a. m. a 10:45 p. m.
                  </p>
                </li>
                <br>
                <br>
                <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 135</span><br>
                    </li> 
                  </ul>
                </li>
              </ul>
        ...
        <div class="js-tabs__content">
          <div class="row col-xs-12">
            <div class="col-sm-12 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                <li>
                  <h3><strong>Programación interactiva</strong> <br> (Creando con Scratch)</h3>
                  <p>
                    <b>Kids y junior (6 a 12 años)</b>
                    Kids: Martes y jueves de 10:00 a. m. a 11:30 a. m.<br>
                    Junior: Lunes y miércoles de 12:30 p. m. a 2:00 p. m.
                  </p>
                  <br>
                  <h3><strong>Edición de video</strong> <br> (Movie creator)</h3>
                  <p>
                    <b>Junior (9 a 12 años)</b>
                    Lunes y viernes de 8:15 a. m. a 9:45 a. m.
                  </p>
                  <br>
                  <h3><strong>Diseño gráfico digital</strong> <br> (Historias y mangas)</h3>
                  <p>
                    <b>Junior (9 a 12 años)</b>
                    Lunes y viernes de 10:45 a. m. a 11:30 p. m.
                  </p>
                </li>
                <br>
                <br>
                <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 130</span><br>
                    </li> 
                  </ul>
                </li>
              </ul>
            ...
            <div class="col-md-12 col-xs-12">
              <ul class="ep-generic-list ep-generic-list--off">
                ...
                <li>
                  ...
                  <p><strong>Aritmética, Álgebra, Física, Razonamiento Matemático, Razonamiento Verbal y Elementos de Geometría</strong></p>
                  <p>Lunes, miércoles y viernes de 8:45 a. m. a 12:30 p. m.</p>
                </li>

                <li>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 3.<sup>er</sup> año</h2>
                  <p><strong>Aritmética, Álgebra, Geometría, Química, Razonamiento Matemático y Razonamiento Verbal.</strong></p>
                  <p>Lunes, miércoles y viernes de 8:45 a. m. a 12:30 p. m.</p>
                </li>
                <li>
                  <br />
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 200</span><br>
                    </li> 
                  </ul>
                </li>
                <br><br><br>
                <li>
                  ...
                  <p><strong>Aritmética, Álgebra, Geometría, Trigonometría, Física, Química, Razonamiento Matemático y Razonamiento Verbal.</strong></p>
                  <p>Martes a viernes de 8:45 a. m. a 12:30 p. m.</p>
                </li>
                <li>
                  <br />
                  <strong><span class="orange">INVERSIÓN</span></strong> <br>
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 240</span><br>
                    </li> 
                  </ul>
                </li>
          ...
          <div class="row col-xs-12">
            <div class="col-md-12 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                ...
                <li>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> SISTEMA 5. ° PRE UNI:</h2>
                  <p><strong>Aritmética, Álgebra, Geometría, Química y Física</strong></p>
                  <p>Lunes a viernes de 8:45 a. m. a 12:30 p. m.</p>
                </li>
                <li>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> SISTEMA 5. ° PRE SAN MARCOS:</h2>
                  <p><strong>Aritmética, Álgebra, Geometría, Física, Química y Biología.</strong></p>
                  <p>Lunes a viernes de 8:45 a. m. a 12:30 p. m.</p>
                </li>
                <!-- <li>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span>SISTEMA 5. ° PRE CATÓLICA:</h2>
                  <p><strong>Aritmética, Álgebra, Geometría, Estadística, Lectura Comprensiva y Crítica.</strong></p>
                  <p>Lunes a viernes de 8:45 a. m. a 12:30 p. m.</p>
                </li> -->
                ...
                <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 260</span><br>
                    </li> 
                  </ul>
                </li>
              </ul>
        ...
        <div class="js-tabs__content">
          <div class="row col-xs-12">
            <div class="col-sm-6 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                <li>
                    <h3><strong>Inglés</strong></h3><br>
                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 1.<sup>er</sup> a 2.<sup>o</sup> año</h2>
                    <p>
                      Martes y jueves de 8:15 a. m. a 10:45 a. m.
                    </p>
                    <br>
                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 3.<sup>er</sup> año</h2>
                    <p>
                      Martes y jueves de 11:00 a. m. a 1:30 p. m.
                    </p>
                  </li>
                  <li>
                  <br />
            ...
            <div class="col-sm-12 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                <li>
                  <h3><strong>Programación interactiva</strong> <br> (Creando con Scratch)</h3>
                  <p>
                    <b>Juvenil (13 a 15 años)</b>
                    Martes y jueves de 8:15 a. m. a 9:45 a. m.
                  </p>
                  <br>
                  <h3><strong>Edición de video</strong> <br> (Movie creator)</h3>
                  <p>
                    <b>Juvenil (13 a 15 años)</b>
                    Martes y jueves de 10:00 a. m. a 11:30 a. m.
                  </p>
                  <br>
                  <h3><strong>Diseño gráfico digital</strong> <br> (Historietas y mangas)</h3>
                  <p>
                    <b>Juvenil (13 a 15 años)</b>
                    Martes y jueves de 12:15 p. m. a 1:45 p. m.
                  </p>
                  <br>
                  <h3><strong>Diseño y animación en 3D</strong> <br> (Modelado en 3D)</h3>
                  <p>
                    <b>Juvenil (13 a 15 años)</b>
                   Lunes y miércoles de 12:30 p. m. a 2:00 p. m.
                  </p>
                </li>
                <br>
                <br>
  ...
  <div class="col-xs-12 col-md-4">
      <article class="formvacas">
        ...
        <link href=/storage/other/landing-static/vacations/css/app.be563d0b.css rel=stylesheet>
          ...
          <div class="ac" id=app></div>

          <script src="https://www.google.com/recaptcha/api.js?onload=vueRecaptchaApiLoaded&render=explicit" async defer></script><script src=/storage/other/landing-static/vacations/js/chunk-vendors.b8d42ec7.js></script><script src=/storage/other/landing-static/vacations/js/app.e31cddb8.js></script>
...
<div class="col-xs-12 vacations__bottom vacations__bottom--orange">
  <div>
    <h1><span><i class="fa fa-lightbulb-o"></i>Inicio: 11 de enero / Término: 16 de febrero</span></h1>
  </div>
</div>