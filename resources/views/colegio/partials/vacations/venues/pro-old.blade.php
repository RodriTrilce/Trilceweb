          ...
          <div class="col-md-12 col-xs-12">
            <ul class="ep-generic-list ep-generic-list--off">
              ...
              <!-- <li>
                ...
                <p><strong>Matemática, Comunicación, Razonamiento Matemático y Razonamiento Verbal.</strong></p>
                <span class="icon_local_span"><i class="fa fa-stop"></i></span> 1.<sup>er</sup> y 2.<sup>o</sup> grado<br>
                <p>Lunes, miércoles y viernes de 8:45 a. m. a 12:30 p. m.</p>
                <br>
                <span class="icon_local_span"><i class="fa fa-stop"></i></span> 3.<sup>er</sup> y 4.<sup>o</sup> grado<br>
                <p>Lunes, miércoles y viernes de 8:45 a. m. a 12:30 p. m.</p>
              </li>
            ...
            <div class="col-sm-12 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                <li>
                  ...
                  <br>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 3.<sup>er</sup> a 4.<sup>o</sup> año</h2>
                  <p>
                    Martes y jueves de 8:15 a. m. a 10:45 a. m.
                  </p>
                  <br>
                  <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 5.<sup>o</sup> y 6.<sup>o</sup> año</h2>
                  <p>
            ...
            <div class="col-sm-12 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                <li>
                  ...
                  <p>
                    <b>Junior (9 a 12 años)</b>
                    Lunes y miércoles de 11:30 a. m. a 1:00 p. m.
                  </p>
                </li>
                <br>
                <br>
