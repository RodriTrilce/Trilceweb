      ...
      <ul class="js-tabs__header">
       ...
       <!--  <li>
        ...
        <li>
          <a href="#" class="js-tabs__title">
            <div>
              <svg version="1.1" class="vacations-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 38 38" enable-background="new 0 0 38 38" xml:space="preserve">
                <g>
                  <path d="M18,27.2l-4.3-1.5c-0.1,0-0.2-0.1-0.3-0.1c-0.4,0-0.8,0.3-0.9,0.7c-0.2,0.5,0.1,1.1,0.6,1.2l4.3,1.5
                		c0.1,0,0.2,0.1,0.3,0.1c0.4,0,0.8-0.3,0.9-0.7C18.8,27.9,18.5,27.3,18,27.2z M18,28.2c-0.1,0.2-0.2,0.2-0.4,0.2l-4.3-1.5
                		c-0.2-0.1-0.3-0.2-0.2-0.4c0-0.1,0.2-0.2,0.3-0.2c0,0,0.1,0,0.1,0l4.3,1.5C18,27.9,18,28,18,28.2z" />
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                ...
                <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 220</span><br>
                    </li> 
                  </ul>
                </li>
            ...
            <div class="col-md-12 col-xs-12">
              <ul class="ep-generic-list ep-generic-list--off">
                ...
                <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 280</span><br>
                    </li> 
                  </ul>
                </li>
            ...
            <div class="col-md-12 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                ...
                <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 300</span><br>
                    </li> 
                  </ul>
                </li>
              </ul>
            ...
            <div class="col-sm-6 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 160</span><br>
                    </li> 
                  </ul>
                </li>
                <br><br><br>
            ...
            <div class="col-sm-12 col-xs-12">
              ...
              <ul class="ep-generic-list ep-generic-list--off">
                ...
                <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 150</span><br>
                    </li> 
                  </ul>
                </li>
              </ul>
