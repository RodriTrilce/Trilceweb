            ...
            <ul class="ep-generic-list ep-generic-list--off">
              ...
              <li>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 140</span><br>
                    </li> 
                  </ul>
                </li>
        ...
        <div class="row col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
                <li>
                    ...
                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 5.<sup>o</sup> a 6.<sup>o</sup> grado</h2>
                    <p>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 120</span><br>
                    </li> 
                  </ul>
                </li>
                <br><br><br>
        ...
        <div class="row col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
                <li>
                    ...
                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 1.<sup>er</sup> y 2.<sup>o</sup> año</h2>
                    <p>
                      Martes y jueves de 8:15 a. m. a 1.45 a. m.
                    </p>
                  </li>
                  <li>
                  <br />
