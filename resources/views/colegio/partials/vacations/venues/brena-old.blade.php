            ...
            <div class="col-md-12 col-xs-12">
              <ul class="ep-generic-list ep-generic-list--off">
                <li>
                  ...
                  <p>Lunes, miércoles y viernes de 8:00 a. m. a 12:00 p. m.</p>
                </li>
                <li>
                  <br />
                ...
                <li>
                  ...
                  <p>Lunes a jueves de 8:00 a. m. a 12:00 p. m.</p>
                </li>
        ...
        <div class="row col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
                <li>
                    ...
                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 1.<sup>o</sup> y 2.<sup>o</sup> año</h2>
                    <p>
                      Martes y jueves de 8:00 a. m. a 10:00 a. m.
                    </p>
                    <br>
                    <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 3.<sup>er</sup> año</h2>
                    <p>
                  ...
                  <ul class="ep-generic-list">
                    <li>
                      <span class="orange">· Pago único: S/ 100</span><br>
                    </li> 
                  </ul>
                </li>
                <br><br><br>
    ...
    <div class="col-xs-12 col-md-4">
      <article class="formvacas">
        ...
        <link href=/storage/other/landing-static/vacations/css/app.be563d0b.css rel=stylesheet>
          ...
          <script src=/storage/other/landing-static/vacations/js/chunk-vendors.b8d42ec7.js></script>
          <script src=/storage/other/landing-static/vacations/js/app.e31cddb8.js></script>
