    ...
    <div class="row col-xs-11 center-xs footer-menu">
      ...
      <div class="col-xs end-xs">
          ...
          <ul class="footer-right-icons">
            ...
            <li><a href="https://www.tiktok.com/@trilce.colegios" title="Tik Tok Academia" target="_blank" rel="nofollow"><img src="{{{ asset('static/images/logos/icono_tik_tok.svg') }}}" alt="TikTok Academia" style="width: 17.5px; vertical-align: inherit"></a></li>
