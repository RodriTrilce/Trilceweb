<?php
	...
	class Reclamaciones extends MY_Controller
	{
		public function __construct()
		{
			parent::__construct();
			$this->load->model('admin/reclamacion_model', 'reclamacion_model');
			$this->load->model('admin/mantenimiento_model', 'mantenimiento_model');
		}

		public function index()
		{
			$data['all_reclamaciones'] =  $this->reclamacion_model->get_all_reclamaciones();
			$data['view'] = 'admin/reclamaciones/reclamacion_list';
