                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <p class="text-left my-4 font-weight-bold">¡Regístrate y participa!</p>
                                    <p class="text-justify my-4 font-weight-normal">Colegios TRILCE lo invita a participar de una noche en la que se acercará a nuestra propuesta educativa y convencerse que somos la mejor opción para la educación de su hijo(a).</p>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <select autofocus class="custom-select" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                        ...
                                        <option value="https://zoom.us/webinar/register/WN_Ybm-JbcWT3uUSyB7WuUqaA">Arequipa</option>
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Callao</option> 
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Chanchamayo</option> 
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Chorrillos</option> 
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Comas</option> 
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Huancayo</option> 
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Jesús María (Salaverry)</option> 
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Los Olivos</option> 
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Pro</option> 
                                        <option value="https://zoom.us/webinar/register/WN_Ybm-JbcWT3uUSyB7WuUqaA">San Isidro</option>
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">San Miguel (Maranga)</option> 
                                        <option value="https://us02web.zoom.us/webinar/register/WN_LDA9yE_GQcuZtNbjuWY5yA">Santa Beatriz (Roma)</option> 
                                        <option value="https://zoom.us/webinar/register/WN_Ybm-JbcWT3uUSyB7WuUqaA">Surco (Caminos del Inca)</option>    
                                        <option value="https://zoom.us/webinar/register/WN_Ybm-JbcWT3uUSyB7WuUqaA">Surco (Marsano)</option>                          
                                        <option value="https://zoom.us/webinar/register/WN_Ybm-JbcWT3uUSyB7WuUqaA">Villa El Salvador</option>
                                        <option value="https://zoom.us/webinar/register/WN_Ybm-JbcWT3uUSyB7WuUqaA">Villa María del Triunfo</option>
                                    </select>
                                </div>
                            </div>
                        </div>
