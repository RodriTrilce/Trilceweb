...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Reporte PMFIEIED</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body table-responsive">
            <table id="example1" class="table table-bordered table-striped ">
                ...
                <tbody>
                    <?php foreach($all_reportes4 as $row): ?>
                    <tr>
    ...
    var table = $('#example1').DataTable({
      ...
      pageLength: 100,
        ...
        buttons: [
            {
                extend: 'excelHtml5',
                title: 'Reporte del curso Procedimientos metodológicos para la formulación del Informe del Impacto de emergencias o desastres'
            }
        ]
    });
