        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body my-form-body">
                    ...
                    <?php echo form_open(base_url('admin/mantenimiento/distrito_add'), 'class="form-horizontal"');  ?> 
                    <div class="form-group">
                        <label for="distrito" class="col-sm-2 control-label">Distrito</label>
                        <div class="col-sm-9">
                            <input type="text" name="distrito" class="form-control" id="distrito" placeholder="">
                        </div>
                    </div>
