...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Reporte PPRRD</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body table-responsive">
            <table id="example1" class="table table-bordered table-striped ">
                ...
                <tbody>
                    <?php foreach($all_reportes5 as $row): ?>
                    <tr>
    ...
    var table = $('#example1').DataTable({
      ...
      pageLength: 100,
        ...
        buttons: [
            {
                extend: 'excelHtml5',
                title: 'Reporte del curso Procedimientos para elaborar el Plan de Prevención y Reducción de Riesgo de Desastres'
            }
        ]
    });
