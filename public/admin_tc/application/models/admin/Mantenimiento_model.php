<?php
	class Mantenimiento_model extends CI_Model
	{
		...
		{
		    $query = $this->db->query(" SELECT * FROM tab_entidad AS ce JOIN tab_gobierno AS cg ON ce.id_gobierno = cg.id_gobierno JOIN tab_sector AS cs ON cg.id_sector=cs.id_sector");
			return $result = $query->result_array();
		}
        
        public function add_entidad($data)
		{
			$this->db->insert('tab_entidad', $data);
			return true;
		}
		...
		public function edit_entidad($data, $id)
		{
			...
			$this->db->update('tab_entidad', $data);
			return true;
		}
		
		public function get_entidad_by_id($id)
		{
			$query = $this->db->get_where('tab_entidad', array('id_entidad' => $id));
			return $result = $query->row_array();
		}
		...
		{
		    $query = $this->db->query(" SELECT * FROM tab_gobierno AS cg JOIN tab_sector AS cs ON cg.id_sector=cs.id_sector");
			return $result = $query->result_array();
		}
        
        public function add_gobierno($data)
		{
			$this->db->insert('tab_gobierno', $data);
			return true;
		}
		...
		public function edit_gobierno($data, $id)
		{
			...
			$this->db->update('tab_gobierno', $data);
			return true;
		}
		
		public function get_gobierno_by_id($id)
		{
			$query = $this->db->get_where('tab_gobierno', array('id_gobierno' => $id));
			return $result = $query->row_array();
		}
		...
		public function get_all_sectores()
		{
			...
			$query = $this->db->get('tab_sector');
			return $result = $query->result_array();
		}
        
        public function add_sector($data)
		{
			$this->db->insert('tab_sector', $data);
			return true;
		}
		...
		public function edit_sector($data, $id)
		{
			...
			$this->db->update('tab_sector', $data);
			return true;
		}
		
		public function get_sector_by_id($id)
		{
			$query = $this->db->get_where('tab_sector', array('id_sector' => $id));
			return $result = $query->row_array();
		}
		...
		public function get_all_perfiles()
		{
			...
			$query = $this->db->get('tab_perfil');
			return $result = $query->result_array();
		}
        
        public function add_perfil($data)
		{
			$this->db->insert('tab_perfil', $data);
			return true;
		}
		...
		public function edit_perfil($data, $id)
		{
			...
			$this->db->update('tab_perfil', $data);
			return true;
		}
		
		public function get_perfil_by_id($id)
		{
			$query = $this->db->get_where('tab_perfil', array('id_perfil' => $id));
			return $result = $query->row_array();
		}
	}
?>