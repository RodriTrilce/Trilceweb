        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 pb50">
                    ...
                    <h3 class="mt60 mb20 text-white title-font h1">¡No te quedes sin vacante!</h3>
                    <p class="text-white-gray mb30 lead">
                        Inscríbete y nos contactaremos contigo para brindarte toda la información sobre nuestros
                        inicios.
                    </p>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb15">
                                    <input id="nombre" name="nombre" type="text" class="form-control"
                                        placeholder="Nombres y apellidos" required="" maxlength="50" autocomplete="off">
                                </div>
                                <div class="col-md-12 mb15">
                                ...
                                <div class="col-md-12 mb15">
                                    <span class="custom-control-description text-white-gray">¿Por qué medio nos contactamos contigo?</span>
                                    ...
                                    <div class="">
                                        <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                            ...
                                            <span class="custom-control-description text-white-gray">Acepto los <a
                                                    href="http://www.trilce.edu.pe/storage/other/documents/politica-de-datos-personales.pdf" class="text-white">términos &amp; condiciones</a></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-12">
