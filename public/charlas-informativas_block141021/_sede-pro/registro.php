...
// INSERTAR
$insertar = "INSERT INTO form_charlas_informativas(_status,  name, dni, name_apoderado, dni_apoderado, venue, grade, phone, email, presentation) VALUES ('$_status', '$name', '$dni', '$name_apoderado', '$dni_apoderado', '$venue', '$grade', '$phone', '$email', '$presentation')";
