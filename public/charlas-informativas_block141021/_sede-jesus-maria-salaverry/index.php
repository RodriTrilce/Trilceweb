                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-12">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="select">
                                                <select required="required" class="custom-select" required name="venue" placeholder="Sede de interés" id="select-sedes">
                                                    <option selected  value="Jesus María Salaverry">Jesus María (Salaverry)</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <input class="form-control font-weight-bolder" type="text" placeholder="Fecha: 26 de noviembre de 2020"   value="26 de noviembre de 2020" name="presentation"   readonly>
                                        </div>
                                    </div>
