...
if ( ! function_exists( 'tabula_color_schemes' ) ) {
	function tabula_color_schemes( $color_scheme_arr ) {
		...
		$theme_color_schemes[] = 'beige-background;Dark font, beige background (or details);#191919;#f2edeb';
		$theme_color_schemes[] = 'accent-gray-skin;Accent font, gray background (or details);' . boldthemes_get_option( 'accent_color' ) . ';#efefef';
		...
		$theme_color_schemes[] = 'accent-beige-background;Accent font, beige background (or details);' . boldthemes_get_option( 'accent_color' ) . ';#f2edeb';
