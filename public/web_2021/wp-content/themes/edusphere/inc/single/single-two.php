								...
								<div class="row blog_banner_tags">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
										...
										<div class="blog_banner_tags_item">
											...
											<p class="site-meta"><?php echo esc_html__( 'Published By:', 'edusphere' ); ?> <strong><a href="<?php echo esc_url( get_author_posts_url( $post->post_author ) ); ?>"><?php echo esc_html( $username->display_name ); ?></a></strong></p>
										</div>
										<!-- blog_banner_tags_item -->
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
										<!-- blog_banner_tags_item -->
										<div class="blog_banner_tags_item">
											<p class="site-meta"><?php echo esc_html__( 'Published On:', 'edusphere' ); ?> <strong><a href="<?php the_permalink(); ?>"><?php echo get_the_date(); ?></a></strong></p>
										</div>
										<!-- blog_banner_tags_item -->
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
										<!-- blog_banner_tags_item -->
										<div class="blog_banner_tags_item">
											<p class="site-meta"><?php echo esc_html__( 'Published In:', 'edusphere' ); ?>
												<strong>
												<?php
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
												...
												<div class="navigation-link nav-previous">
													...
													<a class="link" rel="prev" href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>" title="<?php echo esc_attr( get_the_title( $prev_post->ID ) ); ?>">
														<?php echo esc_html__( 'Older Post', 'edusphere' ); ?>
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
												...
												<div class="navigation-link nav-next">
													...
													<a class="link" rel="next" href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" title="<?php echo esc_attr( get_the_title( $next_post->ID ) ); ?>">
														<?php echo esc_html__( 'Newer Post', 'edusphere' ); ?>
						...
						<div class="row">
							...
							<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12">
								...
								<div class="blog_related_title">
									<h5 class="title"><?php echo esc_html__( 'Related Articles', 'edusphere' ); ?></h5>
								</div>
								<!-- blog_related_title -->
								<!-- blog_related_box -->
