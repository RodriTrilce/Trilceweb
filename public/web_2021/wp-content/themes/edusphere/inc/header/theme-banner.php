...
<?php } elseif ( is_home() ) { ?>
		...
		<?php } elseif (  is_post_type_archive( 'lp_course' ) || is_tax( 'course_category' ) ) { ?>
		<!-- wraper_header_bannerinner -->
			<?php
			$team_page_info        = get_page_by_path( 'courses', OBJECT, 'page' );
			...
			if ( ! empty( $team_featured_img_url ) ) {
				?>
				<div class="wraper_inner_banner course-page-banner" style="background-image:url('<?php echo esc_url( $team_featured_img_url ); ?>')">
			<?php } else { ?>
				<div class="wraper_inner_banner">
			<?php } ?>
			<?php
...
<?php } elseif ( is_singular( 'event' ) || is_tax( 'event-category' ) ) { ?>
		<!-- wraper_header_bannerinner -->
			<?php
			$team_page_info        = get_page_by_path( 'event', OBJECT, 'page' );
			$team_page_id          = $team_page_info->ID;
			$team_featured_img_url = wp_get_attachment_url( get_post_thumbnail_id( $team_page_id ) );
			?>
			<?php
...
<?php } elseif ( is_singular( 'case-studies' ) || is_tax( 'case-study-category' ) ) { ?>
		<!-- wraper_header_bannerinner -->
		<?php
		$case_studies_page_info        = get_page_by_path( 'academic', OBJECT, 'page' );
