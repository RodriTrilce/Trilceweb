	...
	<div class="entry-main">
		<div class="holder">
			...
			<div class="entry-content">
				<p><?php echo wp_kses( substr( strip_tags( get_the_excerpt() ), 0, 80 ), 'post' ) . '...'; ?></p>
			</div><!-- .entry-content -->
			<div class="post-meta">
...
<?php } elseif ( has_post_format( 'status' ) ) { ?>
	...
	<div class="entry-main">
		...
		<div class="entry-content">
			<p><?php echo wp_kses( substr( strip_tags( get_the_excerpt() ), 0, 100 ), 'post' ) . '...'; ?></p>
		</div><!-- .entry-content -->
		<div class="post-meta">
			<?php
			...
			<?php endif; ?>
			<span><?php echo esc_html__( 'by', 'edusphere' ); ?> <?php echo get_the_author_link(); ?></span>
		</div><!-- .post-meta -->
	</div><!-- .entry-main -->
	...
	<div class="entry-main">
		<div class="holder">
			...
			<div class="entry-more">
				<a class="btn" href="<?php esc_url( get_permalink() ); ?>"><span><?php echo esc_html__( 'Read More', 'edusphere' ); ?></span><span class="btn-arrow"><i class="fa fa-angle-right"></i></span></a>
			</div><!-- .entry-more -->
		</div>
	</div><!-- .entry-main -->
