					...
					<div class="container">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<!-- error_main -->
								<div class="error_main">
								    <img src="<?php echo esc_url( get_parent_theme_file_uri( '/assets/images/404-1.png' ) ); ?>" alt="404" />
									<h1><?php echo esc_html__( 'Oops! Page is not available', 'edusphere' ); ?></h1>
									<h5><?php echo esc_html__( "We're not being able to find the page you're looking for", 'edusphere' ); ?></h5>
									
										<a class="btn" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html__( 'Back To Home', 'edusphere' ); ?></a>
