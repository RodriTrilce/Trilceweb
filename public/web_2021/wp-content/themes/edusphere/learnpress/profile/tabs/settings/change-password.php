...
<form method="post" name="profile-change-password" enctype="multipart/form-data" class="learn-press-form">
	...
	<ul class="form-fields">
		...
		<li class="form-field">
			<label for="pass0"><?php _e( 'Old password', 'edusphere' ); ?></label>
			<div class="form-field-input">
				<input type="password" id="pass0" name="pass0" autocomplete="off" class="regular-text"/>
			</div>
		</li>
		<li class="form-field">
			<label for="pass1"><?php _e( 'New password', 'edusphere' ); ?></label>
			<div class="form-field-input">
				<input type="password" name="pass1" id="pass1" class="regular-text" value=""/>
			</div>
		</li>
		<li class="form-field">
			<label for="pass2"><?php _e( 'Confirmation password', 'edusphere' ); ?></label>
			<div class="form-field-input">
				<input name="pass2" type="password" id="pass2" class="regular-text" value=""/>
				<p id="lp-password-not-match"
				   class="description lp-field-error-message hide-if-js"><?php _e( 'New password does not match!', 'edusphere' ); ?></p>
			</div>
		</li>
