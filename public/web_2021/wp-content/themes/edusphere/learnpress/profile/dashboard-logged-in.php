...
<p><?php echo sprintf( __( 'Hello <strong>%1$s</strong> (not %2$s? %3$s)', 'edusphere' ), $user->get_display_name(), $user->get_display_name(), sprintf( '<a href="%s">%s</a>', $profile->logout_url(), __( 'Sign out', 'edusphere' ) ) ); ?></p>
