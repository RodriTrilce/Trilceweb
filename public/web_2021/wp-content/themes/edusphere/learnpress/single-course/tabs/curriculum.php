...
<div class="course-curriculum" id="learn-press-course-curriculum">
	<div class="toggle-item"><a class="toggle-content-item"  href=""></a></div>
	...
	<div class="curriculum-scrollable">
		...
		<?php } else { ?>
			...
			<?php echo apply_filters( 'learn_press_course_curriculum_empty', __( 'Curriculum is empty', 'edusphere' ) ); ?>
