...
<body data-spy="scroll" data-target="#landingkit-navbar" data-offset="74">
    ...
    <div id="home" class=" parallax-fullscreen" data-jarallax='{"speed": 0.2}'
            ...
            <div class="content-middle">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-7 text-center mr-auto ml-auto" style="z-index: 99999999; padding:7% 0%">
                            <h3 class="mb20 h1 font400 pt100 text-white">¡Gracias por registrarte!</h3>
                            <p class=" mb30 lead text-white-gray">
                                <span class="font400">Tus datos fueron enviados correctamente.</span>
                            </p>
                            <div>
                                <a data-scroll href="http://www.trilce.edu.pe/inscripcion-academia/" class="btn btn-primary mr-3 my-3">Nuevo Registro</a>
                                <a data-scroll href="http://www.trilce.edu.pe/academia/" class="btn btn-primary mr-3 my-3">Visita la Web</a>
       ...
       <!--<div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 pt100 pb100">
                    <h5 class="text-white font400 text-uppercase"></h5>
                    <h3 class="mb20 text-white title-font h1">¡No te quedes<br>sin vacante!</h3>
                    <p class="text-white-gray mb30 lead">
                        Inscríbete y nos contactaremos contigo<br> para brindarte toda la información<br> sobre nuestros
                        inicios.
                    </p>
                </div>
            </div>
