...
<body data-spy="scroll" data-target="#landingkit-navbar" data-offset="74">
    ...
    <div id="home" class=" parallax-hero" data-jarallax-video="https://www.youtube.com/watch?v=8LQSe_1D27I"
        ...
        <nav class="navbar navbar-expand-lg navbar-sticky" style="height:100px;">
            <div class="container">
                <a class="navbar-brand" href="http://www.trilce.edu.pe/academia">
                    <span class='logo'>
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 136.8 73.5"
                            enable-background="new 0 0 136.8 73.5" xml:space="preserve">
                            <g>
                                <g>
                                    <path fill="#FFFFFF" d="M62.7,14c-2.3,0-4.2-1.9-4.2-4.2c0-2.3,1.9-4.2,4.2-4.2c2.3,0,4.2,1.9,4.2,4.2C66.9,12.1,65,14,62.7,14
                M79.8,38.8c-0.6,0-1.1-0.5-1.1-1.1V2.1h-7.3v37.2c0,3,2.4,5.4,5.4,5.4H82v-5.8H79.8z M1.9,4.9v9.2h5.8v-2.6h8.9v27.6h-2.6v5.8
                h12.6v-5.8h-2.6V11.4h8.9v2.6h5.8V4.9H1.9z M32.7,18.2v20.7h-2.6v5.8h17.7v-5.8H40V24h7.8v-5.8H32.7z M51.2,18.2V24H59v14.9h-7.8
                ...
                <div class="">
                    <div class="logo-40">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 158.1 61.7"
                            enable-background="new 0 0 158.1 61.7" xml:space="preserve">
                            <g>
                                <g>
                ...
                c0.5,1.7,0.7,3.5,0.7,5.5V24.8z" />
                                    <text transform="matrix(1 0 0 1 44.6072 57.4417)" fill="#FFFFFF"
                                        font-family="'Geogrotesque-Bd'" font-size="7.7627">años</text>
                                </g>
                                <text transform="matrix(1 0 0 1 84.7683 21.4837)">
                                    <tspan x="0" y="0" fill="#FFFFFF" font-family="'Geogrotesque-Md'"
                                        font-size="10.3986">
                                        Esforzándonos</tspan>
                                    <tspan x="0" y="12.5" fill="#FFFFFF" font-family="'Geogrotesque-Md'"
                                        font-size="10.3986">por
                                        lograr tus</tspan>
                                    <tspan x="0" y="25" fill="#FFFFFF" font-family="'Geogrotesque-Md'"
                                        font-size="10.3986">
                                        sueños</tspan>
                                </text>
                            </g>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 pb50">
                    ...
                    <h3 class="mt60 mb20 text-white title-font h1">¡No te quedes<br>sin vacante!</h3>
                    <p class="text-white-gray mb30 lead">
                        Inscríbete y nos contactaremos contigo para<br>brindarte toda la información sobre nuestros
                        inicios.
                    </p>
                </div>
                <div class="col-lg-6 ml-auto">
                    <div class="hero-form">
                        <h3 class="text-white mb15">¡Regístrate!</h3>
                        <form id="inscripcion_academia_trilce">
                            <div class="row">
                                <div class="col-md-12 mb15">
                                    <input id="nombre" name="nombre" type="text" class="form-control"
                                        placeholder="Nombres" required="" maxlength="50" autocomplete="off">
                                </div>
                                <div class="col-md-12 mb15">
                                    <input id="apellido" name="apellido" type="text" class="form-control"
                                        placeholder="Apellidos" required="" maxlength="50" autocomplete="off">
                                </div>
                                <div class="col-md-12 mb15">
                                ...
                                <div class="col-md-12 mb15">
                                    <input id="telefono" name="telefono" type="text" class="form-control"
                                        placeholder="Teléfono" required="" maxlength="9" autocomplete="off">
                                </div>
                                <div class="col-md-12 mb15">
                                    <input id="email" name="email" type="email" class="form-control"
                                        placeholder="E-mail" required="" minlength="7" maxlength="30" autocomplete="off">
                                </div>
                                <div class="col-md-12 mb15">
                                ...
                                <div class="col-md-12 mb15">
                                    <select name="prepa" class="form-control" id="prepa" disabled="disabled">
                                        <option>
                                            Preparación</option>
                                    </select>
                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="medio" id="medio"
                                                        value="whatsapp"> <span
                                                        class="custom-control-description text-white-gray">WhatsApp</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="medio" id="medio"
                                                        value="email"> <span
                                                        class="custom-control-description text-white-gray">E-mail</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="medio" id="medio"
                                                        value="telefono"> <span
                                                        class="custom-control-description text-white-gray">Teléfono</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                            <input id="terminos" name="terminos" type="checkbox"
                                                class="custom-control-input" value="aceptado">
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description text-white-gray">Acepto los <a
                                                    href="http://www.trilce.edu.pe/storage/other/documents/politica-de-datos-personales.pdf"
                                                    class="text-white" target="_new">términos &amp;
                                                    condiciones</a></span>
                                        </label>
                                    </div>
                                </div>
