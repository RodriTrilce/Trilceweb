        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-5">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 class="titulo_opcion_solucionarios">Reconstruidos Católica 2020 - I</h1>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-5 mb-5">
                    <div class="row">
                        <?php
                            include 'controller/solucionarios_catolica.php';
                            if ($result_solucionarios_catolica = $conexion->query($select_solucionarios_catolica)) 
                            {
                                while ($fila = $result_solucionarios_catolica->fetch_assoc()) 
                                {
                        ?>
                        <div class="col-md-4">
                        ...
                        <?php
                                ...
                                $result_solucionarios_catolica->free();
                            }
                        ?>
                    </div>
                </div>
