        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-xl-4 col-lg-4">
                    <h2 class="mb-4 texto_slider" ><?php echo $fila["titulo"];?></h2>
					<button type="submit" class="btn btn-primary2 btn-block texto_solicita vista_home_boton1"><?php echo $fila["opcion1"];?></button>
					<button type="submit" class="btn btn-primary2 btn-block texto_solicita vista_home_boton1"><?php echo $fila["opcion2"];?></button>
                </div>
                <div class="col-xl-4 col-lg-4">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="row">
						<?php
					include 'controller/ciclo_uni_anual.php';
					if ($result_ciclo_uni_anual = $conexion->query($select_ciclo_uni_anual)) 
					{
						/* obtener un array asociativo */
						while ($fila = $result_ciclo_uni_anual->fetch_assoc()) 
						{
				?>
                        <div class="col-md-4 caja_preparacion">
							<button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" <?php if ($fila["id"]==1){ echo "style='color: #fff !important; background-color: #FF4F00 !important;'";}else{echo "";} ?> onclick="window.location.href='<?php echo $fila["enlace"];?>'"><?php echo $fila["ciclo"];?></button>
                        </div>
						<?php
					}
					/* liberar el conjunto de resultados */
					$result_ciclo_uni_anual->free();
				}
				?>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4">
                    <div class="row">
					<?php
					include 'controller/plan_uni_anual.php';
					if ($result_plan_uni_anual = $conexion->query($select_plan_uni_anual)) 
					{
						/* obtener un array asociativo */
						while ($fila = $result_plan_uni_anual->fetch_assoc()) 
						{
				?>
                        <div class="col-lg-6">
                            <div class="p-3">
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-10 fs13">
                                            <h1 class="mt-2 titulo_video2">Ciclo Anual UNI</h1>
                                            <div style="background-color: #fff; padding: 20px" class="mb-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 fs13">
                                                        <span><?php echo $fila["inicio"];?></b>
                                                        <br><br>
                                                        <span><?php echo $fila["fin"];?></span>
                                                        <br><br>
                                                        <span><?php echo $fila["turno"];?></span>
                                                        <br><br>
                                                        <b><?php echo $fila["pago"];?></b>
                                                        <br><br>
                                                        <b style="color: #FF4F00"><?php echo $fila["estado"];?></b>
                                                    </div>
                                                </div>
                                            </div>
                                            <p>
                                            <br></p>
                                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" style="color: #fff !important; background-color: #FF4F00 !important; margin: 0px !important" onclick="window.location.href='<?php echo $fila["horario"];?>'">Descarga el horario completo</button>
                                            <br>
                                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" style="color: #fff !important; background-color: #0DC042 !important; border-color: #0DC042 !important; margin: 0px !important" onclick="window.location.href='<?php echo $fila["whatsapp"];?>'"><img src="images/icono_whatsapp.png"> Matricúlate por WhatsApp</button>
                                        </div>
                                    </div>
                                </p>
                            </div>
                        ...
                        <div class="col-lg-6 mx-auto text-center">
                            <img src="https://www.trilce.edu.pe/web_academia_2021_admin/uploads/photo/<?php echo $fila["foto"];?>" class="foto_width">
                        </div>
						<?php
					}
					/* liberar el conjunto de resultados */
					$result_plan_uni_anual->free();
				}
				?>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 video_fondo">
                    <div class="row">
					<?php
					include 'controller/detalles_uni_anual.php';
					if ($result_detalles_uni_anual = $conexion->query($select_detalles_uni_anual)) 
					{
						/* obtener un array asociativo */
						while ($fila = $result_detalles_uni_anual->fetch_assoc()) 
						{
				?>
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                <h1 class="mt-5 titulo_video"><?php echo $fila["titulo1"];?></h1>
                                <p class="mt-3 parrafo_1">
                                    <?php echo $fila["descripcion1"];?>
                                </p>
                                <img src="https://www.trilce.edu.pe/web_academia_2021_admin/uploads/photo/<?php echo $fila["foto"];?>" class="foto_width">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                <h1 class="mt-5 titulo_video"><?php echo $fila["titulo2"];?></h1>
                                <p class="mt-3 parrafo_1">
                                    <?php echo $fila["descripcion2"];?>
                                </p>
                                <h1 class="mt-5 titulo_video"><?php echo $fila["titulo3"];?></h1>
                                <p class="mt-3 parrafo_1">
                                    <?php echo $fila["descripcion3"];?>
                                </p>
					...
					/* liberar el conjunto de resultados */
					$result_detalles_uni_anual->free();
				}
				?>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4 video_fondo">
                    <div class="row">
                        <div class="col-lg-6 foto_video_uni mx-auto text-center">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="parrafo_2">Nuestro currículo te permite prepararte para el ingreso a las mejores Universidades.</p>
                                <div class="row">
                                        <div class="col-lg-6 fs13">
                                            <ul>
                                                <li>Tutoría</li>
                ...
                <div class="col-lg-12 mb-4 opcion_web">
                    <div class="row">
						...
						<?php
					include 'controller/beneficio_uni_anual.php';
					if ($result_beneficio_uni_anual = $conexion->query($select_beneficio_uni_anual)) 
					{
						/* obtener un array asociativo */
						while ($fila = $result_beneficio_uni_anual->fetch_assoc()) 
						{
				?>
                        <div class="col-md-2">
                            <div class=" text-center p-4">
                                ...
                                <p class="text-muted mb-0 font-size-12 wc-subtitle mt-4 contenido1_opcion"><?php echo $fila["titulo"];?></p>
                            </div>
                        </div>
						<?php
					}
					/* liberar el conjunto de resultados */
					$result_beneficio_uni_anual->free();
				}
				?>
                        <div class="col-md-1">
                        </div>
                ...
                <div class="col-lg-12 mb-4 opcion_mobile">
					...
					if ($result_beneficio_uni_anual = $conexion->query($select_beneficio_uni_anual)) 
					{
						...
						{
				?>
                                <div class="carousel-item <?php if($fila["id"]==1){echo "active";}else{echo "";};?>">
                                    <div class=" text-center p-4">
                                        <img class="mdi mdi-collage icono_opcion" src="https://www.trilce.edu.pe/web_academia_2021_admin/uploads/photo/<?php echo $fila["foto"];?>">
                                        <p class="text-muted mb-0 font-size-12 wc-subtitle mt-4 contenido1_opcion"><?php echo $fila["titulo"];?></p>
                                    </div>
