                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-3 caja_preparacion">
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_san_marcos.php'">Anual</button>
                        </div>
                        <div class="col-md-3 caja_preparacion">
                        ...
                        <div class="col-md-3 caja_preparacion">
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_san_marcos_semestral.php'" style="color: #fff !important; background-color: #FF4F00 !important;">Semestral</button>
                        </div>
                        <div class="col-md-3 caja_preparacion">
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row">
                                ...
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-12 fs13">
                                            <h1 class="mt-2 titulo_video4">Ciclo Semestral San Marcos</h1>
                                            <div style="background-color: #fff; padding: 20px" class="mb-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 fs13">
                                                        <span> 03 de mayo de 2021 </span> <b></b>
                                                        <br><br>
                                                        <span> 18 de setiembre de 2021 </span>
                                                        <br><br>
                                                        <span>Mañan</span>
                                                        <br><br>
                                                        <b>S/ 150</b>
                        ...
                        <div class="col-lg-6 mx-auto text-center">
                            <img src="images/ciclo_semestral_sanmarcos.png" class="foto_width">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                ...
                                <p class="mt-3 parrafo_1">
                                    Dirigido a estudiantes que terminaron 5.º año de secundaria con preparación previa, interesados en postular a la universidad en un próximo examen de admisión.
                                </p>
                                <img src="images/sanmarcos_semestral_imagen.png" class="foto_width">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="mt-3 parrafo_1">
                                    22 semanas, considerando el primer inicio 19 de abril de 2021.
                                </p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4 video_fondo">
                    <div class="row">
                        <div class="col-lg-6 foto_video_sanmarcos_semestral mx-auto text-center">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
