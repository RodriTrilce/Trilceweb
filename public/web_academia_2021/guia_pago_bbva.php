    ...
    <section class="hero-4-bg fondo_slider" id="home">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-xl-4 col-lg-4">
                    <img src="images/guia_pagos/slider0.png" alt="" class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 caja_preparacion">
                            <a href="guia_pago_bbva.php">
                                <img src="images/guia_pagos/logo_bbva_on.svg" alt="" class="vista_home_foto">
                            </a>
                        </div>
                        <div class="col-md-2 caja_preparacion">
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 style="font-family: GR; font-style: normal; font-weight: 500; font-size: 22px; line-height: 22px; color: #FF4F00"><img src="images/guia_pagos/app.svg" alt="" class="logo-dark" width="12" style="margin-right: 20px;"> Guía de pagos APP (BBVA)</h4>
                        </div>
                        <div class="col-lg-3">
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="slideshow-container">
								...
								<?php
									include 'controller/guia_pago_bbva_app.php';
									if ($result_guia_pago_bbva_app = $conexion->query($select_guia_pago_bbva_app)) 
									{
										while ($fila = $result_guia_pago_bbva_app->fetch_assoc()) 
										{
								?>
                                <div class="mySlides">
								...
								<?php
										...
										$result_guia_pago_bbva_app->free();
									}
								?>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 style="font-family: GR; font-style: normal; font-weight: 500; font-size: 22px; line-height: 22px; color: #FF4F00"><img src="images/guia_pagos/web.svg" alt="" class="logo-dark" width="18" style="margin-right: 16px;"> Guía de pagos WEB (BBVA)</h4>
                        </div>
                        <div class="col-lg-3">
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="slideshow2-container">
                                <!-- Full-width images with number and caption text -->
								<?php
									include 'controller/guia_pago_bbva_web.php';
									if ($result_guia_pago_bbva_web = $conexion->query($select_guia_pago_bbva_web)) 
									{
										while ($fila = $result_guia_pago_bbva_web->fetch_assoc()) 
										{
								?>
                                <div class="mySlides2">
									<img src="https://www.trilce.edu.pe/web_academia_2021_admin/uploads/photo/<?php echo $fila["foto"];?>" style="width:100%; padding: 0px 50px 0px 50px;">
                                ...
                                <?php
										...
										$result_guia_pago_bbva_web->free();
									}
								?>
                                <!-- Next and previous buttons -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 style="font-family: GR; font-style: normal; font-weight: 500; font-size: 22px; line-height: 22px; color: #FF4F00"><img src="images/guia_pagos/otro.svg" alt="" class="logo-dark" width="12" style="margin-right: 20px;"> Guía de pagos VENTANILLA (BBVA)</h4>
                        </div>
                        <div class="col-lg-1">
                        </div>
                        <div class="col-lg-10" style="text-align: center;">
                            ...
                            <img src="images/guia_pagos/indicar_codigo_bbva.png">
                            <img src="images/guia_pagos/divisor.png"> 
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 style="font-family: GR; font-style: normal; font-weight: 500; font-size: 22px; line-height: 22px; color: #FF4F00"><img src="images/guia_pagos/otro.svg" alt="" class="logo-dark" width="12" style="margin-right: 20px;"> Guía de pagos AGENTE (BBVA)</h4>
                        </div>
                        <div class="col-lg-1">
                        </div>
                        <div class="col-lg-10" style="text-align: center;">
