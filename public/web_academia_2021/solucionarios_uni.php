...
<body>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-4 col-lg-4">
                    ...
                    <div class="contenedor_solucionarios opacity_solucionarios">
    ...
    <section class="section2 fondo_cursos_solucionarios" style="padding-bottom: 0px !important; padding-top: 0px !important">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-5">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 class="titulo_opcion_solucionarios">Solucionarios UNI 2020 - I</h1>
                        </div>
                        <div class="col-md-6" style="text-align: right;">
                            <form>
                                <select class="event-type-select opcion_solucionarios">
                                  <option value="all">Selecione año</option>
                                  <option value="music">Año 2020 - I</option>
                                  <option value="food">Año 2019 - II</option>
                                  <option value="art">Año 2019 - I</option>
                                  <option value="fashion">Año 2018 - I</option>
                                  <option value="sport">Año 2017 - II</option>
                                  <option value="history">Año 2017 - I</option>
                                </select>
                            </form>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-5 mb-5">
                    <div class="row">
                        <?php
                            include 'controller/solucionarios_uni.php';
                            if ($result_solucionarios_uni = $conexion->query($select_solucionarios_uni)) 
                            {
                                while ($fila = $result_solucionarios_uni->fetch_assoc()) 
                                {
                        ?>
                        <div class="col-md-4">
                            <div class="contenedor_cursos_solucionarios" style="background-color: <?php echo $fila["color"]; ?>">
                                <img src="https://www.trilce.edu.pe/web_academia_2021_admin/uploads/photo/<?php echo $fila["foto"];?>" class="foto_cursos_solucionarios">
                                <div style="padding: 30px;">
                                    <h1 class="titulo_cursos_solucionarios"><?php echo $fila["titulo"]; ?></h1>
                                    <button class="boton_cursos_solucionarios" style="color: <?php echo $fila["color"]; ?>" onclick="location.href='<?php echo $fila["enlace_1"]; ?>';">Descargar claves</button>
                                    <button class="boton_cursos_solucionarios" style="color: <?php echo $fila["color"]; ?>" onclick="location.href='<?php echo $fila["enlace_2"]; ?>';">Descargar solucionario</button>
                                </div>
                            </div>
                        </div>
                        <?php
                                }
                                $result_solucionarios_uni->free();
                            }
                        ?>
                    </div>
                </div>
    ...
    $(".event-type-select").change(function () 
    {
        ...
        {
            $(".container_curso div").removeClass("hidden");
        } 
        else 
        {
            $(".container_curso div").addClass("hidden");
            $('.container_curso div[data-eventtype="' + selectedEventType + '"]').removeClass("hidden");
        }
    });
    </script>
