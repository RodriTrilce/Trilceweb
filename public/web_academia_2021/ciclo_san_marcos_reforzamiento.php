            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-3 caja_preparacion">
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_san_marcos_reforzamiento.php'" style="color: #fff !important; background-color: #FF4F00 !important;">Reforzamiento</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row">
                                ...
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-12 fs13">
                                            <h1 class="mt-2 titulo_video4">Ciclo Reforzamiento<br>(Ciencias y Letras)</h1>
                        ...
                        <div class="col-lg-6 mx-auto text-center">
                            <img src="images/ciclo_reforzamiento_sanmarcos.png" class="foto_width">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                ...
                                <p class="mt-3 parrafo_1">
                                    Dirigido a estudiantes próximos a postular en el mes de abril.
                                </p>
                                <img src="images/sanmarcos_reforzamiento_imagen.png" class="foto_width">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="mt-3 parrafo_1">
                                    5 semanas, considerando el primer inicio 22 de marzo de 2021.
                                </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class=" text-center p-4">
                                                ...
                                                <p class="text-muted mb-0 font-size-12 wc-subtitle mt-4 contenido1_opcion">100% práctica</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4 video_fondo">
                    <div class="row">
                        <div class="col-lg-6 foto_video_sanmarcos_reforzamiento mx-auto text-center">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
