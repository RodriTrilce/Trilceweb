            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-3 caja_preparacion">
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_san_marcos_tarde.php'" style="color: #fff !important; background-color: #FF4F00 !important;">Anual Tarde</button>
                        </div>
                        <div class="col-md-3 caja_preparacion">
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row">
                                ...
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-12 fs13">
                                            <h1 class="mt-2 titulo_video4">Ciclo Anual San Marcos (Tarde)</h1>
                                            ...
                                            <p>Horario de clases: Lunes a sábado de 4:00 p. m. a 9:00 p. m.* 
                        ...
                        <div class="col-lg-6 mx-auto text-center">
                            <img src="images/ciclo_anual_tarde_sanmarcos.png" class="foto_width">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                ...
                                <img src="images/sanmarcos_anual_tarde_imagen.png" class="foto_width">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="mt-3 parrafo_1">
                                    38 semanas, considerando el primer inicio 15 de marzo de 2021.
                                </p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4 video_fondo">
                    <div class="row">
                        <div class="col-lg-6 foto_video_sanmarcos_tarde mx-auto text-center">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
