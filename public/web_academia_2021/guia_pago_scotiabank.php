                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 caja_preparacion">
                            <a href="guia_pago_bcp.php">
                                <img src="images/guia_pagos/logo_bcp_off.svg" alt="" class="vista_home_foto">
                            </a>
                        </div>
                        <div class="col-md-4 caja_preparacion">
                            <center>
                                <a href="guia_pago_scotiabank.php">
                                    <img src="images/guia_pagos/logo_scotia_on.svg" alt="" class="vista_home_foto">
                                </a>
                            </center>
                        </div>
                        <div class="col-md-2 caja_preparacion">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 style="font-family: GR; font-style: normal; font-weight: 500; font-size: 22px; line-height: 22px; color: #FF4F00"><img src="images/guia_pagos/app.svg" alt="" class="logo-dark" width="12" style="margin-right: 20px;"> Guía de pagos APP (Scotiabank)</h4>
                        </div>
                        <div class="col-lg-3">
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="slideshow-container">
								...
								<?php
									include 'controller/guia_pago_scotiabank_app.php';
									if ($result_guia_pago_scotiabank_app = $conexion->query($select_guia_pago_scotiabank_app)) 
									{
										while ($fila = $result_guia_pago_scotiabank_app->fetch_assoc()) 
										{
								?>
                                <div class="mySlides">
								...
								<?php
										...
										$result_guia_pago_scotiabank_app->free();
									}
								?>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 style="font-family: GR; font-style: normal; font-weight: 500; font-size: 22px; line-height: 22px; color: #FF4F00"><img src="images/guia_pagos/web.svg" alt="" class="logo-dark" width="18" style="margin-right: 16px;"> Guía de pagos WEB (Scotiabank)</h4>
                        </div>
                        <div class="col-lg-3">
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="slideshow2-container">
                                <!-- Full-width images with number and caption text -->
								<?php
									include 'controller/guia_pago_scotiabank_web.php';
									if ($result_guia_pago_scotiabank_web = $conexion->query($select_guia_pago_scotiabank_web)) 
									{
										while ($fila = $result_guia_pago_scotiabank_web->fetch_assoc()) 
										{
								?>
                                <div class="mySlides2">
                                    <img src="https://www.trilce.edu.pe/web_academia_2021_admin/uploads/photo/<?php echo $fila["foto"];?>" style="width:100%; padding: 0px 50px 0px 50px;">
								...
								<?php
										...
										$result_guia_pago_scotiabank_web->free();
									}
								?>
                                <!-- Next and previous buttons -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 style="font-family: GR; font-style: normal; font-weight: 500; font-size: 22px; line-height: 22px; color: #FF4F00"><img src="images/guia_pagos/otro.svg" alt="" class="logo-dark" width="12" style="margin-right: 20px;"> Guía de pagos VENTANILLA (Scotiabank)</h4>
                        </div>
                        <div class="col-lg-3">
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 style="font-family: GR; font-style: normal; font-weight: 500; font-size: 22px; line-height: 22px; color: #FF4F00"><img src="images/guia_pagos/otro.svg" alt="" class="logo-dark" width="12" style="margin-right: 20px;"> Guía de pagos AGENTE (Scotiabank)</h4>
                        </div>
                        <div class="col-lg-1">
                        </div>
                        <div class="col-lg-10" style="text-align: center;">
                            <p class="divisor"></p>
                            <img src="images/guia_pagos/parrafo_scotia.png">
                            <p class="divisor"></p>
                            <p class="divisor"></p>
                        </div>
                        <div class="col-lg-1">
