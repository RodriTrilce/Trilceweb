        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-4 col-lg-4">
                    <h2 class="mb-4 texto_slider" >Preparación<br>Ciclo Escolar</h2>
					<button type="submit" class="btn btn-primary2 btn-block texto_solicita vista_home_boton1">Inicio: Incorporaciones</button>
                </div>
                <div class="col-xl-4 col-lg-4">
                    <img src="images/ciclos_escolar/foto_slider_escolar_2021.png" alt="" class="vista_home_foto">
                </div>
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row">
                                ...
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-10 fs13">
                                            <h1 class="mt-2 titulo_video2">Ciclo Escolar</h1>
                        ...
                        <div class="col-lg-6 mx-auto text-center">
                            <img src="images/ciclo_escolar_2021.png" class="foto_width">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                ...
                                <p class="mt-3 parrafo_1">
                                    Dirigido a estudiantes de 4.º y 5.º de secundaria de los colegios nacionales y particulares.
                                </p>
                                <img src="images/escolar_2021_imagen.png" class="foto_width">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="mt-3 parrafo_1">
                                    El plan de estudios del <b>CICLO ESCOLAR</b> se encuentra diseñado para reforzar cursos ejes de la malla académica y ayudar a los estudiantes a finalizar un año con notas satisfactorias.
                                </p>
                                <h1 class="mt-5 titulo_video">Duración</h1>
                                <p class="mt-3 parrafo_1">
                                    17 semanas, considerando el primer inicio 29 de marzo de 2021.
                                </p>
