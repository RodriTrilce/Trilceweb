        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-5">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 class="titulo_opcion_solucionarios">Solucionarios San Marcos 2020 - I</h1>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-5 mb-5">
                    <div class="row">
                        <?php
                            include 'controller/solucionarios_san_marcos.php';
                            if ($result_solucionarios_san_marcos = $conexion->query($select_solucionarios_san_marcos)) 
                            {
                                while ($fila = $result_solucionarios_san_marcos->fetch_assoc()) 
                                {
                        ?>
                        <div class="col-md-4">
                        ...
                        <?php
                                ...
                                $result_solucionarios_san_marcos->free();
                            }
                        ?>
                    </div>
                </div>
