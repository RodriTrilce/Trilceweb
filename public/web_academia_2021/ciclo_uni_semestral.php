        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-4 col-lg-4">
                    <h2 class="mb-4 texto_slider" >Preparación<br>Ciclos UNI</h2>
					<button type="submit" class="btn btn-primary2 btn-block texto_solicita vista_home_boton1">Anual: Incorporaciones</button>
					<button type="submit" class="btn btn-primary2 btn-block texto_solicita vista_home_boton1">Semestral: Incorporaciones</button>
                </div>
                <div class="col-xl-4 col-lg-4">
                    <img src="images/ciclos_uni/foto_slider_uni1.png" alt="" class="vista_home_foto">
                </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-4 caja_preparacion">
							<button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_uni.php'">Anual</button>
                        </div>
						<div class="col-md-4 caja_preparacion">
							<button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" style="color: #fff !important; background-color: #FF4F00 !important;" onclick="window.location.href='ciclo_uni_semestral.php'">Semestral</button>
                        </div>
						<div class="col-md-4 caja_preparacion">
							<button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_uni_escolar.php'">Escolar</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row">
                                ...
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-10 fs13">
                                            <h1 class="mt-2 titulo_video2">Ciclo Semestral UNI</h1>
                                            <div style="background-color: #fff; padding: 20px" class="mb-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 fs13">
                                                        <span>15 de marzo de 2021</span> <b>(Incorporaciones)</b>
                                                        <br><br>
                                                        <span>18 de diciembre de 2021</span>
                                                        <br><br>
                                                        <span>Mañana</span>
                                                        <br><br>
                                                        <b>S/ 150</b>
                                                        <br><br>
                                                        <b style="color: #FF4F00">Disponible</b>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-6 mx-auto text-center">
                            <img src="images/ciclo_semestral_uni.png" class="foto_width">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                ...
                                <p class="mt-3 parrafo_1">
                                    Estudiantes que terminaron 5.º año de secundaria con preparación previa, interesados en postular la universidad en un próximo examen de admisión.
                                </p>
                                <img src="images/uni_semestral_imagen.png" class="foto_width">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="mt-3 parrafo_1">
                                    El plan de estudios se encuentra diseñado con los cursos y temas que la Universidad Nacional de Ingeniería ha considerado en sus exámenes de admisión, sumado a nuestra plana de docente con experiencia en la preparación para el ingreso a esta casa de estudios.
                                </p>
                                <h1 class="mt-5 titulo_video">Duración</h1>
                                <p class="mt-3 parrafo_1">
                                    21 semanas, considerando el primer inicio 15 de marzo de 2021.
                                </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class=" text-center p-4">
                                                ...
                                                <p class="text-muted mb-0 font-size-12 wc-subtitle mt-4 contenido1_opcion">30% teoría</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class=" text-center p-4">
                                                <img class="mdi mdi-collage icono_opcion" src="images/icono_practica.png">
                                                <p class="text-muted mb-0 font-size-12 wc-subtitle mt-4 contenido1_opcion">70% práctica</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4 video_fondo">
                    <div class="row">
                        <div class="col-lg-6 foto_video_uni_semestral mx-auto text-center">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                ...
                <div class="col-lg-12 mb-4 opcion_web">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class=" text-center p-4">
                                <img class="mdi mdi-collage icono_opcion" src="images/seminarios_finales2.png">
                                <p class="text-muted mb-0 font-size-12 wc-subtitle mt-4 contenido1_opcion">Seminarios finales</p>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class=" text-center p-4">
                                <img class="mdi mdi-collage icono_opcion" src="images/examen_final2.png">
                                <p class="text-muted mb-0 font-size-12 wc-subtitle mt-4 contenido1_opcion">Exámenes semanales.</p>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class=" text-center p-4">
                                <img class="mdi mdi-collage icono_opcion" src="images/video_grabados2.png">
