        ...
        <div class="col-md-4 my-4 select-cole">
            <select class="input-field" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
              ...
              <optgroup label="Sedes en Lima">
				  ...
				  <option selected value="https://www.trilce.edu.pe/libro-de-reclamaciones/nana">Ñaña</option>
    ...
    <div class="container">
      <div class="row py-4 ">
        ...
        <div class="col-md-7 text-right my-2">
          ...
          <br>
          <span> DIRECCIÓN: AV. BERNARDO BALAGUER, LOTE 5 (ANTES CALLE REAL) DE LA LOTIZACIÓN FUNDO ÑAÑA, LURIGANCHO-CHOSICA</span>
        </div>
      </div>
    </div>
  </section>
       ...
       <div class="container">
        <div class="row my-0">
           <div class="offset-md-2 col-md-8 offset-md-2 text-right">
            ...
            <input name="sede" id="sede" value="Ñaña" hidden>
           </div>
        </div>
        <div class="row">
