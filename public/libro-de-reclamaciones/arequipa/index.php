      	...
      	<div class="row box-nav">
        	...
        	<div class="col-xs-6 col-md-6 d-flex justify-content-end align-items-center" >
            	<div class="d-flex">
              		...
              		<aside>
                  		<a class="text-white" href="https://api.whatsapp.com/send?phone=51922336565&amp;text=Me%20gustar%C3%ADa%20obtener%20m%C3%A1s%20informaci%C3%B3n" target="_blank">
        	...
        	<div class="col-md-4 my-4 select-cole">
            	<select class="input-field" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                 	...
                 	<optgroup label="Sedes en provincia">
                     	<option selected value="https://www.trilce.edu.pe/libro-de-reclamaciones/arequipa">Arequipa</option>
    ...
    <div class="container">
      	<div class="row py-4 ">
        	<div class="col-md-5 text-left my-2">
          		<b class="font-weight-bold">RAZÓN SOCIAL: ASOCIACIÓN EDUCATIVA BENAVIDES</b>
          		<br>
          		<span class="d-flex date">FECHA: &nbsp;<div id="date"> </div></span>
        	</div>
        	<div class="col-md-7 text-right my-2">
          		<b class="font-weight-bold">RUC: 20519161401</b>
          		<br>
          		<span> DIRECCIÓN: AV. BENAVIDES NRO. 1850 MIRAFLORES  - LIMA</span>
        	</div>
      	</div>
    </div>
</section>
...
<section class="formulario py-5">
	<form action="./registro.php" name="reclamaciones" id="reclamaciones" method="post">
       	<div class="container">
        	<div class="row my-0">
           		<div class="offset-md-2 col-md-8 offset-md-2 text-right">
             		...
             		<input name="razon_social" id="razon_social" value="Asociación Educativa Benavides" hidden>
            		<input name="ruc" id="ruc" value="20519161401" hidden>
            		<input name="institucion" id="institucion" value="Colegio" hidden>
            		<input name="sede" id="sede" value="Arequipa" hidden>
           		</div>
        	</div>
						...
						<div class="input-field col-xs-12 col-md-6 px-0 pr-2 ">
							<select id="grado" name="grado">
								...
								<optgroup label="Primaria">
									<option value="Primaria - 1.° Año">1.° Año</option>
									<option value="Primaria - 2.° Año">2.° Año</option>
									<option value="Primaria - 3.° Año">3.° Año</option>
									<option value="Primaria - 4.° Año">4.° Año</option>
									<option value="Primaria - 5.° Año">5.° Año</option>
									<option value="Primaria - 6.° Año">6.° Año</option>
								</optgroup>
