      ...
      <div class="row d-flex justify-content-center align-items-center">
        ...
        <div class="col-md-4 select-acad">
            <select class="input-field"
              ...
              <option selected value="https://www.trilce.edu.pe/libro-de-reclamaciones/academia-santa-beatriz">Santa Beatriz</option>
       ...
       <div class="container">
        <div class="row my-0">
           <div class="offset-md-2 col-md-8 offset-md-2 text-right">
            ...
            <input name="sede" id="sede" value="Santa Beatriz" hidden>
           </div>
        </div>
		<div class="row">
