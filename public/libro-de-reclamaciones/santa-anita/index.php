        ...
        <div class="col-md-4 my-4 select-cole">
            <select class="input-field" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
              ...
              <optgroup label="Sedes en Lima">
                  ...
                  <option selected value="https://www.trilce.edu.pe/libro-de-reclamaciones/santa-anita">Santa Anita</option>
    ...
    <div class="container">
      <div class="row py-4 ">
        <div class="col-md-5 text-left my-2">
          <b class="font-weight-bold">RAZÓN SOCIAL: ASOCIACIÓN EDUCATIVA LA FONTANA</b>
          <br>
          <span class="d-flex date">FECHA: &nbsp;<div id="date"> </div></span>
        </div>
        <div class="col-md-7 text-right my-2">
          <b class="font-weight-bold">RUC: 20516382041</b>
          <br>
          <span> DIRECCIÓN: AV. JAVIER PRADO NRO. 5840 - LA MOLINA  - LIMA</span>
        </div>
      </div>
    </div>
  </section>
       ...
       <div class="container">
        <div class="row my-0">
           <div class="offset-md-2 col-md-8 offset-md-2 text-right">
             ...
             <input name="razon_social" id="razon_social" value="Asociación Educativa La Fontana" hidden>
            <input name="ruc" id="ruc" value="20516382041" hidden>
            <input name="institucion" id="institucion" value="Colegio" hidden>
            <input name="sede" id="sede" value="Santa Anita" hidden>
           </div>
        </div>
        <div class="row">
