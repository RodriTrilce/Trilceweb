        ...
        <div class="col-md-4 my-4 select-cole">
            <select class="input-field" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
              ...
              <optgroup label="Sedes en Lima">
                  <option selected value="https://www.trilce.edu.pe/libro-de-reclamaciones/brena">Breña</option>
    ...
    <div class="container">
      <div class="row py-4 ">
        <div class="col-md-5 text-left my-2">
          <b class="font-weight-bold">RAZÓN SOCIAL: ASOCIACIÓN EDUCATIVA SOARISABEL</b>
          <br>
          <span class="d-flex date">FECHA: &nbsp;<div id="date"> </div></span>
        </div>
        <div class="col-md-7 text-right my-2">
          <b class="font-weight-bold">RUC: 20518149165</b>
          <br>
          <span> DIRECCIÓN: AV. ZORRITOS NRO. 159 URB. CHACRA COLORADA - BREÑA  - LIMA</span>
        </div>
      </div>
    </div>
  </section>
...
<section class="formulario py-5">
	<form action="./registro.php" name="reclamaciones" id="reclamaciones" onsubmit="return validateForm()" method="post" name="form">
		<div class="container">
			<div class="row my-0">
				<div class="offset-md-2 col-md-8 offset-md-2 text-right">
					...
					* Campos obligatorios
					...
					<input name="razon_social" id="razon_social" value="Asociación Educativa Soarisabel" hidden>
					<input name="ruc" id="ruc" value="20518149165" hidden>
					<input name="institucion" id="institucion" value="Colegio" hidden>
					<input name="sede" id="sede" value="Breña" hidden>
				</div>
			</div>
			<div class="row">
