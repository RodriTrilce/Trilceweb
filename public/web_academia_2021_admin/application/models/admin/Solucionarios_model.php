...
class Solucionarios_model extends CI_Model
{
    public $v_fields=array('foto', 'titulo', 'enlace_1', 'enlace_2', 'color', 'categoria_solucionarios.categoria', 'subcategoria_solucionarios.subcategoria');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , categoria_solucionarios.categoria as categoria  , subcategoria_solucionarios.subcategoria as subcategoria ");
        $this->db->from($table);
         $this->db->join("categoria_solucionarios", "solucionarios.categoria = categoria_solucionarios.id", "left");  $this->db->join("subcategoria_solucionarios", "solucionarios.subcategoria = subcategoria_solucionarios.id", "left");     
