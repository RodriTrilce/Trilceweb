...
class Subcategoria_solucionarios_model extends CI_Model
{
    public $v_fields=array('subcategoria', 'categoria_solucionarios.categoria');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , categoria_solucionarios.categoria as id_categoria ");
        $this->db->from($table);
         $this->db->join("categoria_solucionarios", "subcategoria_solucionarios.id_categoria = categoria_solucionarios.id", "left");     
