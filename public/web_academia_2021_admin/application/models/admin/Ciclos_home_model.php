...
class Ciclos_home_model extends CI_Model
{
    public $v_fields=array('imagen', 'titulo', 'subtitulo', 'enlace', 'estado.estado', 'fecha_registro');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , estado.estado as id_estado ");
        $this->db->from($table);
         $this->db->join("estado", "ciclos_home.id_estado = estado.id", "left");     
