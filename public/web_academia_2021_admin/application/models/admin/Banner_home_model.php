...
{
    public $v_fields=array('icono', 'titulo', 'subtitulo', 'imagen', 'formulario', 'orden', 'fecha_registro', 'estado.estado');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->from($table);
         $this->db->join("estado", "banner_home.id_estado = estado.id", "left");     
