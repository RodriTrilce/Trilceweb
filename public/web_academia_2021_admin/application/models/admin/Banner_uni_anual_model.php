...
class Banner_uni_anual_model extends CI_Model
{
    public $v_fields=array('titulo', 'opcion1', 'opcion2', 'foto', 'formulario', 'estado.estado');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->from($table);
         $this->db->join("estado", "banner_uni_anual.estado = estado.id", "left");     
