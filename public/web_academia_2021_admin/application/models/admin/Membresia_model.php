...
{
    public $v_fields=array('titulo', 'subtitulo', 'descripcion', 'precio', 'periodo_membresia.periodo', 'tipo_membresia.tipo_membresia', 'estado.estado', 'fecha_registro');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , periodo_membresia.periodo as id_periodo_membresia  , tipo_membresia.tipo_membresia as id_tipo_membresia  , estado.estado as id_estado ");
        $this->db->from($table);
         $this->db->join("periodo_membresia", "membresia.id_periodo_membresia = periodo_membresia.id_periodo_membresia", "left");  $this->db->join("tipo_membresia", "membresia.id_tipo_membresia = tipo_membresia.id_tipo_membresia", "left");  $this->db->join("estado", "membresia.id_estado = estado.id_estado", "left");     
    ...
    function getRow($table, $id) {
        $this->db->select('*');
        $query = $this->db->get_where($table, array('id_membresia' => $id));
        $data = $query->result();
        return $data[0];
    }
