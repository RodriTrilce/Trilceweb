...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo",html_entity_decode($guia_pago_bcp_web->titulo)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("subtitulo",html_entity_decode($guia_pago_bcp_web->subtitulo)); ?>"
...
<!-- Subtitulo End -->
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$guia_pago_bcp_web->estado?'selected="selected"':""; ?>>
