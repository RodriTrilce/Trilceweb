...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo",html_entity_decode($solucionarios->titulo)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("enlace_1",html_entity_decode($solucionarios->enlace_1)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("enlace_2",html_entity_decode($solucionarios->enlace_2)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("color",html_entity_decode($solucionarios->color)); ?>"
...
<!-- Color End -->
	...
	<div class="form-group">
      ...
      foreach($categoria_solucionarios as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$solucionarios->categoria?'selected="selected"':""; ?>>
	...
	<div class="form-group">
      ...
      foreach($subcategoria_solucionarios as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$solucionarios->subcategoria?'selected="selected"':""; ?>>
