  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
      ...
      foreach($reserva as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_reserva; ?>" <?php echo $value->id_reserva==$detalle_reserva->id_reserva?'selected="selected"':""; ?>>
	...
	<div class="form-group">
      ...
      foreach($servicio as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_servicio; ?>" <?php echo $value->id_servicio==$detalle_reserva->id_servicio?'selected="selected"':""; ?>>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("precio",html_entity_decode($detalle_reserva->precio)); ?>"
