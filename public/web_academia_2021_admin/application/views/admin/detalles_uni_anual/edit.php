...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo1",html_entity_decode($detalles_uni_anual->titulo1)); ?>"
  ...
  <div class="col-sm-5" >
    ...
    <?php echo form_error("titulo1","<span class='label label-danger'>","</span>")?>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("descripcion1",html_entity_decode($detalles_uni_anual->descripcion1)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo2",html_entity_decode($detalles_uni_anual->titulo2)); ?>"
  ...
  <div class="col-sm-5" >
    ...
    <?php echo form_error("titulo2","<span class='label label-danger'>","</span>")?>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("descripcion2",html_entity_decode($detalles_uni_anual->descripcion2)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo3",html_entity_decode($detalles_uni_anual->titulo3)); ?>"
  ...
  <div class="col-sm-5" >
    ...
    <?php echo form_error("titulo3","<span class='label label-danger'>","</span>")?>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("descripcion3",html_entity_decode($detalles_uni_anual->descripcion3)); ?>"
