...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("ciclo",html_entity_decode($ciclo_uni_anual->ciclo)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("enlace",html_entity_decode($ciclo_uni_anual->enlace)); ?>"
...
<!-- Enlace End -->
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$ciclo_uni_anual->estado?'selected="selected"':""; ?>>
