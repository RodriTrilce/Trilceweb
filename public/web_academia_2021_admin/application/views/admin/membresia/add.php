  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
      ...
      foreach($periodo_membresia as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_periodo_membresia; ?>">
	...
	<div class="form-group">
      ...
      foreach($tipo_membresia as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_tipo_membresia; ?>">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="fecha_registro" name="fecha_registro" value="<?php echo set_value("fecha_registro","2020-08-16"); ?>"	    >
