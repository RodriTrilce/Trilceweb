   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>admin/usuario_medio_pago/add" class="btn btn-info">ADD NEW</a>
            <div class="form-group pull-right">
               <a href="<?php echo $csvlink; ?>" class="btn btn-info">CSV</a>
               <a href="<?php echo $pdflink; ?>" class="btn btn-info">PDF</a>
            </div>
            <form method="GET" action="<?php echo base_url().'admin/usuario_medio_pago/index'; ?>" class="form-inline ibox-content">
               <div class="form-group">
                  <select name="searchBy" class="form-control">
                  <option value="medio_pago.medio_pago" <?php echo $searchBy=="medio_pago.medio_pago"?'selected="selected"':""; ?>>Id_medio_pago</option><option value="usuario.usuario" <?php echo $searchBy=="usuario.usuario"?'selected="selected"':""; ?>>Id_usuario</option>
                  </select>
               </div>
               <div class="form-group">
               ...
               <tbody>
                  ...
                  <?php 
                     foreach ($results as $key => $value) {
                      ...
                      ?>
                  <tr  id="hide<?php echo $value->id_usuario_medio_pago; ?>" >
                  <th><input name='input' id='del' onclick="callme('show')"  type='checkbox' class='del' value='<?php echo $value->id_usuario_medio_pago; ?>'/></th>

                              

            <th><?php if(!empty($value->id_usuario_medio_pago)){ echo $count; $count++; }?></th><th><?php if(!empty($value->id_medio_pago)){ echo $value->id_medio_pago; }?></th>

                <th><?php if(!empty($value->id_usuario)){ echo $value->id_usuario; }?></th>

                <th class="action-width">

		   <a href="<?php echo base_url()?>admin/usuario_medio_pago/view/<?php echo $value->id_usuario_medio_pago; ?>" title="View">

            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>

           </a>

           <a href="<?php echo base_url()?>admin/usuario_medio_pago/edit/<?php echo $value->id_usuario_medio_pago; ?>" title="Edit">

            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>

           </a>

           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id_usuario_medio_pago; ?>','usuario_medio_pago');">
...
<script type="text/javascript">
   ...
   $.ajax({
     type:"POST",
     url:'<?php echo base_url()."admin/usuario_medio_pago/deleteAll"; ?>',
     data:{
       allIds : ids,
