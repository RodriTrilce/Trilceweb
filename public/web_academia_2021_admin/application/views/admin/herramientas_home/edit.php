  ...
  <div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="form-group">
      ...
      value="<?php if (isset($foto) && $foto!=""){echo $foto; }?>" />  
        ...
        <?php if (isset($herramientas_home->foto) && $herramientas_home->foto!=""){?>

            <br>

  <img src="<?php echo $this->config->item("photo_url");?><?php echo $herramientas_home->foto; ?>" alt="pic" width="50" height="50" />
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo",html_entity_decode($herramientas_home->titulo)); ?>"
