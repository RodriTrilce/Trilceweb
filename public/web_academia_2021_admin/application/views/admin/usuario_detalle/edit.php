...
<div class="row">
  <div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_antecedentes_penales" 

      value="<?php if (isset($antecedentes_penales) && $antecedentes_penales!=""){echo $antecedentes_penales; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $usuario_detalle->antecedentes_penales; ?>" alt="pic" width="50" height="50" />
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_estado; ?>" <?php echo $value->id_estado==$usuario_detalle->estado_ap?'selected="selected"':""; ?>>
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_verificacion_domociliaria" 

      value="<?php if (isset($verificacion_domociliaria) && $verificacion_domociliaria!=""){echo $verificacion_domociliaria; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $usuario_detalle->verificacion_domociliaria; ?>" alt="pic" width="50" height="50" />
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_estado; ?>" <?php echo $value->id_estado==$usuario_detalle->estado_vd?'selected="selected"':""; ?>>
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_ruc_personal" 

      value="<?php if (isset($ruc_personal) && $ruc_personal!=""){echo $ruc_personal; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $usuario_detalle->ruc_personal; ?>" alt="pic" width="50" height="50" />
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_estado; ?>" <?php echo $value->id_estado==$usuario_detalle->estado_rp?'selected="selected"':""; ?>>
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_entrevista" 

      value="<?php if (isset($entrevista) && $entrevista!=""){echo $entrevista; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $usuario_detalle->entrevista; ?>" alt="pic" width="50" height="50" />
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_estado; ?>" <?php echo $value->id_estado==$usuario_detalle->estado_e?'selected="selected"':""; ?>>
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_evaluacion_destrezas" 

      value="<?php if (isset($evaluacion_destrezas) && $evaluacion_destrezas!=""){echo $evaluacion_destrezas; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $usuario_detalle->evaluacion_destrezas; ?>" alt="pic" width="50" height="50" />
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_estado; ?>" <?php echo $value->id_estado==$usuario_detalle->estado_ed?'selected="selected"':""; ?>>
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_corroborar_referencia" 

      value="<?php if (isset($corroborar_referencia) && $corroborar_referencia!=""){echo $corroborar_referencia; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $usuario_detalle->corroborar_referencia; ?>" alt="pic" width="50" height="50" />
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_estado; ?>" <?php echo $value->id_estado==$usuario_detalle->estado_cr?'selected="selected"':""; ?>>
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="fecha_registro" id="fecha_registro" value="<?php echo set_value("fecha_registro",$usuario_detalle->fecha_registro); ?>"/> 
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="fecha_actualizacion" id="fecha_actualizacion" value="<?php echo set_value("fecha_actualizacion",$usuario_detalle->fecha_actualizacion); ?>"/> 
	...
	<div class="form-group">
      ...
      foreach($usuario as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_usuario; ?>" <?php echo $value->id_usuario==$usuario_detalle->id_usuario?'selected="selected"':""; ?>>
