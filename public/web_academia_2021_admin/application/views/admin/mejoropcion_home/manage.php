...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-10">
      <h2>Mejoropcion_home</h2>
      <ol class="breadcrumb">
         <li>
            <a href="<?php echo base_url().'admin/'?>">Dashboard</a>
         </li>
         <li class="active">
            <strong>Mejoropcion_home</strong>
         </li>
      </ol>
   </div>
   <div class="col-lg-2">
   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>admin/mejoropcion_home/add" class="btn btn-info">ADD NEW</a>
            <div class="form-group pull-right">
               <a href="<?php echo $csvlink; ?>" class="btn btn-info">CSV</a>
               <a href="<?php echo $pdflink; ?>" class="btn btn-info">PDF</a>
            </div>
            <form method="GET" action="<?php echo base_url().'admin/mejoropcion_home/index'; ?>" class="form-inline ibox-content">
               <div class="form-group">
                  <select name="searchBy" class="form-control">
                  <option value="titulo" <?php echo $searchBy=="titulo"?'selected="selected"':""; ?>>Titulo</option>
                  </select>
               </div>
               <div class="form-group">
         ...
         <div class="table table-responsive">
		   ...
		   <a href="<?php echo base_url()?>admin/mejoropcion_home/view/<?php echo $value->id; ?>" title="View">

            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>

           </a>

           <a href="<?php echo base_url()?>admin/mejoropcion_home/edit/<?php echo $value->id; ?>" title="Edit">

            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>

           </a>

           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id; ?>','mejoropcion_home');">
...
<script type="text/javascript">
   ...
   $.ajax({
     type:"POST",
     url:'<?php echo base_url()."admin/mejoropcion_home/deleteAll"; ?>',
     data:{
       allIds : ids,
