  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="fecha_inicio" name="fecha_inicio" value="<?php echo set_value("fecha_inicio","2020-08-16"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="fecha_fin" name="fecha_fin" value="<?php echo set_value("fecha_fin","2020-08-16"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4 clockpicker" data-autoclose="true">
	    ...
	    <input type="text" class="form-control" value="09:30" name="hora_inicio">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4 clockpicker" data-autoclose="true">
	    ...
	    <input type="text" class="form-control" value="09:30" name="hora_fin">
	...
	<div class="form-group">
      ...
      foreach($medio_pago as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_medio_pago; ?>">
