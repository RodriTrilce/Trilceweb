...
<div class="row">
  <div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_icono" value="<?php if (isset($icono) && $icono!=""){echo $icono; } ?>" />
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_imagen" value="<?php if (isset($imagen) && $imagen!=""){echo $imagen; } ?>" />
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("formulario"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("orden"); ?>"
