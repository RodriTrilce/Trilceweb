  ...
  <div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="form-group">
      ...
      value="<?php if (isset($foto) && $foto!=""){echo $foto; }?>" />  
        ...
        <?php if (isset($guia_pago_bbva_web->foto) && $guia_pago_bbva_web->foto!=""){?>

            <br>

  <img src="<?php echo $this->config->item("photo_url");?><?php echo $guia_pago_bbva_web->foto; ?>" alt="pic" width="50" height="50" />
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo",html_entity_decode($guia_pago_bbva_web->titulo)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("subtitulo",html_entity_decode($guia_pago_bbva_web->subtitulo)); ?>"
...
<!-- Subtitulo End -->
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$guia_pago_bbva_web->estado?'selected="selected"':""; ?>>
