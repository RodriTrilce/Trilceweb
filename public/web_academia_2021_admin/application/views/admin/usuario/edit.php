...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("usuario",html_entity_decode($usuario->usuario)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("clave",html_entity_decode($usuario->clave)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("email",html_entity_decode($usuario->email)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nombres",html_entity_decode($usuario->nombres)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("apellidos",html_entity_decode($usuario->apellidos)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="experiencia" name="experiencia"><?php echo set_value("experiencia",html_entity_decode($usuario->experiencia)); ?></textarea>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("anio",html_entity_decode($usuario->anio)); ?>"
...
<!-- Anio End -->
	...
	<div class="form-group">
      ...
      foreach($distrito as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_distrito; ?>" <?php echo $value->id_distrito==$usuario->id_distrito?'selected="selected"':""; ?>>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="direccion" name="direccion"><?php echo set_value("direccion",html_entity_decode($usuario->direccion)); ?></textarea>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("telefono",html_entity_decode($usuario->telefono)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("celular",html_entity_decode($usuario->celular)); ?>"
...
<!-- Celular End -->
	...
	<div class="form-group">
      ...
      foreach($perfil as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_perfil; ?>" <?php echo $value->id_perfil==$usuario->id_perfil?'selected="selected"':""; ?>>
