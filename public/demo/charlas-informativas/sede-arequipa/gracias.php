        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-7">
                    <figure>
                        <img src="../images/IMG-PRINCIPAL.png" />
                    </figure>
                </div>
                            ...
                            <div class="col-xs-12 col-md-12">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 text-center mb-5">  
                                        <div class="card">
                                            <h4 class="orange font-weight-bold">¡Gracias por registrarte!</h4>
                                            <p class="gray">Recuerda los datos de la charla:</p>
                                            <p class="gray">Día: 18 de noviembre</p>
                                            <p class="gray">Hora: 7:00 p. m.</p>
                                            <p class="gray">Plataforma: Zoom</p>
                                            <br>
                                            <p class="gray font-weight-bold">¡Te esperamos!</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12 mb-5">
                                        <a class="btn btn-form btn-lg orange btn-grax" href="http://www.trilce.edu.pe/charlas-informativas/" type="submit">Regresar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="row box">
                            <div class="col-sm-12 col-md-8 box-div">
                                    ...
                                    <span class="text-left">Revista nuestra <b>Propuesta Educativa</b></span>
