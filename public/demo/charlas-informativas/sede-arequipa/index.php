                            ...
                            <div class="col-xs-12 col-md-12">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="select">
                                                <select required="required" class="custom-select" required name="venue" placeholder="Sede de interés" id="select-sedes">
                                                    <option selected  value="Arequipa">Arequipa</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <div class="select">
                                                <select required="required" class="custom-select"  name="grade" placeholder="Grado de interés" id="select-arequipa">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <input class="form-control font-weight-bolder" type="text" placeholder="Fecha: 18 de noviembre de 2020" readonly>
                                        </div>
                                    </div>
