...
<nav class="navbar navbar-expand-lg navbar-light container">
    ...
    <li class="nav-item">
        <a class="nav-link" href="#"><i class="las la-home text-light 32px h3"></i></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#"><i class="lab la-whatsapp text-light 32px h3"></i></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#"><i class="las la-phone text-light 32px h3"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <input class="form-control" type="tel" name="dni_apoderado"   minlength="8"  maxlength="8"   onkeypress="return onlyNumberKey(event)" placeholder="DNI del apoderado *" />
                                        </div>
                                    </div>
                    ...
                    <div class="select mt-2 mb-4">
                        ...
                        <select autofocus class="custom-select" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                            <option selected disabled>Seleccione una sede</option>
                                <option value="https://www.trilce.edu.pe/demo/charlas-informativas/sede-arequipa">Arequipa</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-callao">Callao</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-chanchamayo">Chanchamayo</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-chorrillos">Chorrillos</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-comas">Comas</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-huancayo">Huancayo</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-jesus-maria-salaverry">Jesús María (Salaverry)</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-los-olivos">Los Olivos</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-pro">Pro</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-san-isidro">San Isidro</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-san-miguel-maranga">San Miguel (Maranga)</option>
                                <option value="https://www.trilce.edu.pe/charlas-informativas/sede-santa-beatriz-roma">Santa Beatriz (Roma)</option>
