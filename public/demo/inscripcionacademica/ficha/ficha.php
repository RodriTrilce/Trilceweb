...
<div id="page_ficha" style="position:relative;width:1262px;height:892px;margin: 0 auto;">
	...
	<img width="1262" height="892" src="https://www.trilce.edu.pe/demo/inscripcionacademica/ficha/ficha-final.svg" style="width: 1262px; height:892px" alt="background image" >
				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-4">
						<article class="py-4"> 
							...
							<p class="text-center px-3">Solo tienes 24 horas para realizar el pago. Una vez hecho el depósito, nos envías tu voucher al correo: <a href="mailto:registro.academias@trilce.edu.pe">registro.academias@trilce.edu.pe</a></p>
						</article>
					</div>
				</div>
				<div class="row">
