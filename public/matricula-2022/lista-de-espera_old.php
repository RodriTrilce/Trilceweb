            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height">
                    <div class="ml80">
						...
						<img src="images/colegio/logo-matricula-2022.svg" alt="Trilce Colegio" class="mt40">
                    </div>
                    <div class="ml80">
                        <p class="contenedor_descripcion_colegio">Regístrate y nos comunicaremos contigo cuando iniciemos nuestro proceso de admisión 2022.</p>
                        <form class="registration-form w_form" action="landing_gracias_colegio.php" method="post">
                            <div class="form-group mb-2">
                                <input type="text" class="form-control fondo_blanco" id="nombres_apellidos" name="nombres_apellidos" placeholder="Nombres y apellidos" required="required">
                            </div>
							<div class="form-group mb-2">
