                    ...
                    <div class="ml80">
                        ...
                        <form class="registration-form w_form" action="landing_gracias_colegio_sat.php" method="post">
                            <div class="form-group mb-2">
                                <input type="text" class="form-control fondo_blanco" id="dni" name="dni" placeholder="DNI del alumno" required="required" minlength="8" maxlength="9">
                            </div>
							<div class="form-group mb-2">
							...
							<div class="form-group mb-2">
                                <input type="text" class="form-control fondo_blanco" id="telefono" name="telefono" placeholder="Teléfono" required="required" minlength="7" maxlength="12">
                            </div>
							<div class="form-group mb-2">
