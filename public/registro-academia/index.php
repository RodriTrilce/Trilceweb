...
<head>
    <meta charset="utf-8" />
    <title>Academia Trilce 2025</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Formulario de Registro Academia: San Marcos - UNI - Cátolica - Escolar" />
    <meta name="keywords" content="Academia Trilce 2023 - San Marcos - UNI - Cátolica - Escolar" />
...
<body>
    ...
    <section class="section2 fondo_primeros_puestos pad0">
        <div class="container-fluid mb_m">
            <div class="row justify-content-center clas_espe">
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height">
                    ...
                    <div class="ml80">
                        ...
                        <p class="subtitulo_academia">Selecciona el tipo de preparación:</p>

                        <div class="w40 contenedor_ciclo inline">
                            <a href="landing-formulario-uni.php">
                            <div class="row">
                                <div class="col-lg-12 col-xs-12 tac">
                        ...
                        <div class="w40 contenedor_ciclo inline">
                            <a href="landing-formulario-san-marcos.php">
                            <div class="row">
                                <div class="col-lg-12 col-xs-12 tac">
                        ...
                        <p class="espacio_index">&nbsp;</p>
                        <div class="w40 contenedor_ciclo inline">
                            <a href="landing-formulario-catolica.php">
                            <div class="row">
                                <div class="col-lg-12 col-xs-12 tac">
                                    <img src="images/academia/catolica.svg" alt="Logo Academia">
                                    <h1 class="h1_ciclo">Preparación</h1>
                                    <p class="p_ciclo">Católica</p>
                                </div>
                            </div>
                            </a>
                        </div>
                        ...
                        <!--div class="w40 contenedor_ciclo inline">
                            <a href="landing-formulario-escolar.php">
                            <div class="row">
                                <div class="col-lg-12 col-xs-12 tac">
                        ...
                        <p class="texto_footer">© 2025 Trilce. Todos los derechos reservados.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="more_information md-hide sm-hide">
            <span class="more_information__call">
                <a href="https://www.trilce.edu.pe/l/whatsapp-academias" style="color: #fff" class="texto_foot"><i class="fa fa-whatsapp"></i> ¡Inscríbete aquí! </a>
            </span>
        </div>
    </section>
