...
if ($ciclo == "00100")
{
    $subject = "¡Gracias por registrarte! - Ciclo Anual San Marcos - Trilce Academia";
	require 'r_sm/anual.php';	
}
elseif ($ciclo == "23001")
{
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height_2">
                    ...
                    <div class="ml80">
                        ...
                        <div class="contenedor_gracias_registro">
                            <h2 class="usted_eligio">Usted eligió:<br><b class="usted_bold">Preparación SAN MARCOS</b></h2>
