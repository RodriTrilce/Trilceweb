...
<head>
    <meta charset="utf-8" />
    <title>Academia Trilce <?php echo date("Y"); ?> - Preparación SAN MARCOS</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Formulario para el registro de Preparación SAN MARCOS" />
    <meta name="keywords" content="Preparación SAN MARCOS" />
  ...
  <section class="section2 fondo_primeros_puestos pad0">
    <div class="container-fluid">
      <div class="row justify-content-center">
        ...
        <div class="col-lg-6 fondo_landing_interno full_height clas_espe">
        </div>
        <div class="col-lg-6 pt-4 fondo_registro_2021 full_height">
          <div class="ml80">
            ...
            <div class="ml80">
              ...
              <p class="subtitulo_academia">Usted eligió: <b class="texto_preparacion">Preparación SAN MARCOS</b></p>
              <form class="registration-form w_form" action="landing-gracias-san-marcos.php" method="post">
                ...
                <a href="https://www.trilce.edu.pe/l/whatsapp-san-marcos" target="_blank" class="btn btn-primary btn-block texto_solicita vista_home_boton1" style="width: 296px; height: 36px; background-color: #FF4E0E !important; border: 2px solid #fff !important; color: #fff !important; font-family: GRB; font-size: 18px !important"><img src="images/w_b.svg" alt="Trilce Colegios" style="width: 24px"> ¡Inscríbete por WhatsApp!</a>
              </form>
    ...
    <div class="more_information md-hide sm-hide">
    	<span class="more_information__call">
      	<a href="https://www.trilce.edu.pe/l/whatsapp-san-marcos" target="_blank" style="color: #fff" class="texto_foot"><i class="fa fa-whatsapp"></i> ¡Inscríbete aquí! </a>
    	</span>
  	</div>
  </section>
