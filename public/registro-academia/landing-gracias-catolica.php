...
$myfile 	= fopen("logs_ca.txt", "a") or die("Unable to open file!");
...
elseif ($ciclo == "00124")
{
    ...
    $subject = "¡Gracias por registrarte! - Ciclo Semestral Católica - Trilce Academia";
    require 'r_pucp/semestral.php';
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height_2">
                    ...
                    <div class="ml80">
                        ...
                        <div class="contenedor_gracias_registro">
                            <h2 class="usted_eligio">Usted eligió:<br><b class="usted_bold">Preparación CATÓLICA</b></h2>
