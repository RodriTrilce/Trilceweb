...
$CODE_URL			= "25ad82a9eb";
$BLDG_TBL			= $_SESSION["BLDG_TBL"];
$NIVEL_ESTUDIO		= $_SESSION["NIVEL_ESTUDIO"];
$SERVICIO			= $_SESSION["SERVICIO"];
$CODIGO_AREA		= $_SESSION["CODIGO_AREA"];
$CODIGO_CARRERA		= $_SESSION["CODIGO_CARRERA"];
$ANIO_ACADEMICO		= $_SESSION["ANIO_ACADEMICO"];
...
$NRO_CELULAR		= $_SESSION["NRO_CELULAR"];

$RP_NOMBRES			= $_POST['nombres_rp'];
$RP_APE_PATERNO		= $_POST['apellido_paterno_rp'];
$RP_APE_MATERNO		= $_POST['apellido_materno_rp'];
$RP_TIPO_DOC		= "01";
$RP_NRO_DOC			= $_POST['dni_rp'];
$RP_SEXO			= $_POST['sexo_rp'];
...
$RP_REQ_FACTURA		= $valor;
$RP_NRO_RUC			= $_POST['ruc_rp'];
$RP_RAZON_SOCIAL	= $_POST['razon_rp'];
$RP_DIREC_FISCAL	= $_POST['direccion_rp'];
...
'RP_NOMBRES'=> $RP_NOMBRES,
'RP_APE_PATERNO'=> $RP_APE_PATERNO,
'RP_APE_MATERNO'=> $RP_APE_MATERNO,
'RP_TIPO_DOC'=> $RP_TIPO_DOC,
'RP_NRO_DOC'=> $RP_NRO_DOC,
'RP_SEXO'=> $RP_SEXO,
'RP_REQ_FACTURA'=> $RP_REQ_FACTURA,
'RP_NRO_RUC'=> $RP_NRO_RUC,
'RP_RAZON_SOCIAL'=> $RP_RAZON_SOCIAL,
'RP_DIREC_FISCAL'=> $RP_DIREC_FISCAL);
...
<section class="section2 fondo_primeros_puestos pad0">
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 fondo_landing_externo full_height_2">
                </div>
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height_2">
                    ...
                    <div class="ml80 mt40">
                        ...
                        <p class="subtitulo_academia">Usted eligió: Simulacros Cátolica</p>
                        <div class="contenedor_gracias_registro">
                            <h2 class="usted_eligio">¡Gracias por<br>registrarte!</h2>
                            <p class="enviado">Hemos enviado un mail con la información detallada del simulacro elegido al correo que has registrado. <strong>Recuerda que el simulacro es GRATUITO por ser Alumno de Academias Trilce.</strong></p>
                            <a href="https://www.trilce.edu.pe/l/guia-pagos-simulacros" class="botones_enlaces_volver">Ver guía de pagos</a>
