            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height_2">
                    ...
                    <div class="ml80 mt40">
                        ...
                        <p class="subtitulo_academia">Seleccione universidad:</p>
                        <div class="w40 contenedor_ciclo">
                            <a href="landing_sininscripcion_externo.php">
                            <div class="row">
                                <div class="col-lg-5 col-xs-5 tar">
                                    <img src="images/academia/logo-uni.svg" alt="Logo Academia">
                                </div>
                                <div class="col-lg-7 col-xs-7">
                                    <h1 class="h1_ciclo">Simulacros</h1>
                        ...
                        <div class="w40 contenedor_ciclo">
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-xs-5 tar">
                                    <img src="images/academia/logo-san-marcos.svg" alt="Logo Academia">
                                </div>
                                <div class="col-lg-7 col-xs-7">
                                    <h1 class="h1_ciclo">Simulacros</h1>
                        ...
                        <div class="w40 contenedor_ciclo" style="display: none">
                            <a href="landing_sinvacante_catolica_externo.php">
                            <div class="row">
                                <div class="col-lg-5 col-xs-5 tar">
                                    <img src="images/academia/logo-catolica.svg" alt="Logo Academia">
                                </div>
                                <div class="col-lg-7 col-xs-7">
                                    <h1 class="h1_ciclo">Simulacros</h1>
