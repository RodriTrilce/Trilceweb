            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height2">
                    ...
                    <div class="ml80 mt40">
                        ...
                        <form class="registration-form w_form" action="landing_formulario_uni_2_externo.php" method="post">
                            ...
                            <div class="form-group mb-2" style="display:none">
                                <select class="form-control fondo_blanco icono_select" id="tipo_examen" name="tipo_examen" style="color: #b0aec6 !important;">
