    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-6 pt-4 fondo_registro_2021 full_height2">
        ...
        <div class="ml80 mt40">
          ...
          <p class="subtitulo_academia2 sin_p">Usted eligió: Simulacros Cátolica</p>
          <p class="subtitulo_academia">2. DATOS RESPONSABLE DE PAGO::</p>
          <form class="registration-form w_form" action="landing_gracias_catolica_externo.php" method="post">
            ...
            <div class="form-group mb-2">
              <input type="text" class="form-control fondo_blanco" id="parentesco_rp" name="parentesco_rp" placeholder="Parentesco" required="required">
            </div>
            <div class="form-group mb-2">
              <input type="checkbox" id="acepta" name="acepta" required="required"> <span class="texto_acepta" style="color: #fff">¿Requiere factura?</span>
            </div>
            <div class="form-group mb-2">
              <input type="text" class="form-control fondo_blanco" id="ruc_rp" name="ruc_rp" placeholder="RUC" required="required">
            </div>
            <div class="form-group mb-2">
              <input type="text" class="form-control fondo_blanco" id="razon_rp" name="razon_rp" placeholder="Razón Social" required="required">
            </div>
            <div class="form-group mb-2">
              <input type="text" class="form-control fondo_blanco" id="direccion_rp" name="direccion_rp" placeholder="Dirección Fiscal" required="required">
            </div>
            <div class="form-group mb-2">
              <a href="landing_formulario_catolica_externo.php" class="botones_enlaces_redux">Anterior</a>
