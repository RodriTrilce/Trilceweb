...
$myfile 	= fopen("logs_catolica.txt", "a") or die("Unable to open file!");
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 <?php echo $var_style; ?>">
                    ...
                    <div class="ml80 mt40">
                        ...
                        <div class="contenedor_gracias_registro">
                            ...
                            <a href="https://www.trilce.edu.pe/academia/preparacion-pucp" class="botones_enlaces_volver_2">Ver en nuestra web</a>
                        </div>
