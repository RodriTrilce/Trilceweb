            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021">
                    ...
                    <div class="ml80 mt40">
                        ...
                        <form class="registration-form w_form" action="landing_gracias_uni.php" method="post" id="form1">
						...
						<p class="pie">© 2021 Academia Trilce. Todos los derechos reservados.</p>
                    </div>
                </div>
            </div>
        </div>
