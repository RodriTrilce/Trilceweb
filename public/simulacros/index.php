            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height_2">
                    ...
                    <div class="ml80 mt40">
                        ...
                        <p class="subtitulo_academia">Seleccione una opción:</p>
                        <div class="w40">
                            <div class="row">
                                <div class="col-lg-12 col-xs-12">
                                    <a href="alumno_trilce.php" class="botones_enlaces">Alumno Trilce</a>
                                    <a href="alumno_externo.php" class="botones_enlaces">Alumno Externo</a>
                                </div>
                                <p class="fecha_mensaje">*Inscripciones válidas hasta el domingo 27 de noviembre de 2022.</p>
                            </div>
                        </div>						
