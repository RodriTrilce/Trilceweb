...
<section class="section2 fondo_primeros_puestos pad0">
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <?php if ($validar="1"){$var_style="full_height_2";}else{$var_style="full_height";}?>
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 <?php echo $var_style; ?>">
					...
					<div class="ml80 mt40">
                        ...
                        <div class="contenedor_gracias_registro">
                            ...
                            <a href="https://www.trilce.edu.pe/academia" class="botones_enlaces_volver_2">Ver en nuestra web</a>
                        </div>
