...
$myfile 	= fopen("logs_catolica_externo.txt", "a") or die("Unable to open file!");
...
if($validar=='1')
{
	...
	$mail->addBCC('');
	$subject = "Simulacro tipo admisión CATÓLICA";
...
<section class="section2 fondo_primeros_puestos pad0">
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                ?>
                <div class="col-lg-6 fondo_landing_externo <?php echo $var_style; ?>">
                </div>
                <div class="col-lg-6 pt-4 fondo_registro_2021 <?php echo $var_style; ?>">
                    ...
                    <div class="ml80 mt40">
                        ...
                        <p class="subtitulo_academia">Usted eligió: Simulacros Católica</p>
                        <div class="contenedor_gracias_registro">
                            <h2 class="usted_eligio">¡Gracias por<br>registrarte!</h2>
                            <p class="enviado">Hemos enviado un mail con la información detallada del simulacro elegido al correo que has registrado. <strong>Recuerda que debes realizar el pago de S/ 10 por derecho del simulacro.</strong></p>
                            ...
                            <a href="https://www.trilce.edu.pe/academia/preparacion-catolica" class="botones_enlaces_volver_2">Ver en nuestra web</a>
                        </div>
