...
$_SESSION["CODIGO_AREA"]        = "C";
$_SESSION["NIVEL_ESTUDIO"]      = "SIICA";
$_SESSION["CODE_URL"]           = "958dd40537";
$_SESSION["CODIGO_CARRERA"]     = "38";
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-6 pt-4 fondo_registro_2021 full_height2">
        ...
        <div class="ml80 mt40">
          ...
          <form class="registration-form w_form" action="landing_gracias_catolica_externo.php" method="post" id="form2">
