...
<head>
  ...
  <style>
    ...
    #sede-uni-verano,
    #sede-uni-anual,
    #sede-uni-verano-especial,
    #sede-uni-semestral,
    #sede-uni-seleccion,
    #sede-uni-ciclo-escolar,
    #sede-uni-semestraldos,
    #sesion-uni-repaso,
    #sesion-uni-verano,
    #sesion-uni-anual,
    #sesion-uni-verano-especial,
    #sesion-uni-semestral,
    #sesion-uni-seleccion,
    #sesion-uni-ciclo-escolar,
    #sesion-uni-semestraldos,
    #seccion-uni-repaso,
    #seccion-uni-verano,
    #seccion-uni-anual,
    #seccion-uni-verano-especial,
    #seccion-uni-semestral,
    #seccion-uni-semestral-manana,
    #seccion-uni-semestral-tarde,
    #seccion-uni-seleccion,
    #seccion-uni-ciclo-escolar,
    #seccion-uni-semestraldos,
    #seccion-uni-semestraldos-manana,
    #seccion-uni-semestraldos-tarde {
      display: none;
    }
...
<nav class="fixed-top py-1">
 ...
 <section class="banner d-flex justify-content-center align-items-center text-center">
                    ...
                    <!-- /****************/ FECHA DE INICIO /***************/ -->
                        ...
                        <div class="col-xs-12 col-md-4">
                            <fieldset class="form-group">
                                ...
                                <option value="ACAUN" selected="">Pre UNI</option>
  ...
  <!-- SCRIPTS -->
  <!-- JQuery -->
  <script type="text/javascript" src="../sjs/jquery.min.js"></script>
