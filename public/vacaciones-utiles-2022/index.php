...
<head>
    <meta charset="utf-8" />
    <title>Vacaciones Útiles 2022 - Colegio Trilce</title>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 pt-3 fondo_registro_2021 full_height">
                    <div class="ml80">
						...
						<img src="images/logo_charlas.svg" alt="Trilce Colegio" class="logo_charlas">
                    </div>
                    <div class="ml80 pleft">
                        <p class="contenedor_descripcion_colegio">Regístrate y te enviaremos toda la información.</p>
                        <form class="registration-form w_form" action="gracias.php" method="post">
                            ...
                            <div class="form-group mb-2">
                                <input type="text" class="form-control fondo_blanco" id="nombre" name="nombre" placeholder="Nombre del alumno" required="required">
                            </div>
							<div class="form-group mb-2">
                                <input type="text" class="form-control fondo_blanco" id="paterno" name="paterno" placeholder="Apellido paterno del alumno" required="required">
                            </div>
							<div class="form-group mb-2">
                                <input type="text" class="form-control fondo_blanco" id="materno" name="materno" placeholder="Apellido materno del alumno" required="required">
                            </div>
                            <div class="form-group mb-2">
							...
							<div class="form-group mb-2">
                                <input type="text" class="form-control fondo_blanco" id="telefono" name="telefono" placeholder="Télefono" onkeypress="return isNumber(event)" onpaste="return false;" minlength="7" maxlength="12" required="required">
                            </div>
							<div class="form-group mb-2">
                                <select class="form-control fondo_blanco icono_select" id="sede" name="sede" required="required" style="color: #b0aec6 !important;">
                                    <option value="">Sede de interés</option>
                                </select>
                            </div>
                            <div class="form-group mb-2">
                                <select class="form-control fondo_blanco icono_select" id="grado" name="grado" required="required" style="color: #b0aec6 !important;">
                                    <option value="">Grado de interés</option>
                                </select>
                            </div>
                            <div class="form-group mb-2">
								<center>
									<input type="checkbox" name="acepta" required="required" class="checkbox-round"> <span class="texto_acepta" style="color: #fff">He leido y acepto <a class="check-div-a>" id="myBtn" style="color: #fff;text-decoration: underline !important;font-family: 'NSB';cursor: pointer;">términos y condiciones.</b></a></span>
								</center>
							</div>
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1">Solicitar información</button>
							<button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton2" style="width: 70%">Registrar</button>
                        </form>
                        <div class="form-group mb-2">
                        </div>
							         <p class="pie">© 2021 Trilce. Todos los derechos reservados.</p>
                    </div>
                </div>
            </div>
        </div>
