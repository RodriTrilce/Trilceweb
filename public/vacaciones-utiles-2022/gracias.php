...
switch ($_POST['sede']) 
{
	...
	case "Los Olivos":
		...
		break;
	case "Maranga (San Miguel)":
		$datos_sede = "Maranga (San Miguel)";
		break;
	case "Pro":
		$datos_sede = "Pro";
		break;
	case "Santa Beatriz (Roma)":
		$datos_sede = "Santa Beatriz (Roma)";
		break;
	case "Salaverry (Jesús María)":
		$datos_sede = "Salaverry (Jesús María)";
		break;
	case "San Isidro":
...
$subject = "Vacaciones Útiles 2022 - Trilce Colegio";
...
elseif($datos_sede == "Maranga (San Miguel)")
{
...
elseif($datos_sede == "Santa Beatriz (Roma)")
{
	require 'sedes/roma.php';	
}
elseif($datos_sede == "Salaverry (Jesús María)")
{
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height_2">
                    ...
                    <div class="ml80" style="padding-left: 10px;">
						...
						<div class="gracias_contenedor">
                            ...
                            <button type="submit" style="border: 2px solid #FF7738 !important; width:80%" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="location.href='index.php';"><b style="font-family: NSB !important">Volver</b></button>
							<button type="submit" style="border: 2px solid #FF7738 !important; width:80%" class="btn btn-primary btn-block texto_solicita vista_home_boton2" onclick="location.href='index.php';"><b style="font-family: NSB !important">Volver</b></button>
                        </div>
