...
$nombres_apoderado = $_SESSION["nombres_apoderado"];
$celular_apoderado = $_SESSION["celular_apoderado"];
$correo_apoderado = $_SESSION["correo_apoderado"];
$producto_servicio = $_SESSION["producto_servicio"];
$monto_reclamado = $_SESSION["monto_reclamado"];
$descripcion = $_SESSION["descripcion"];
$reclamo_queja = $_SESSION["reclamo_queja"];
$detalle = $_SESSION["detalle"];
$pedido_concreto = $_SESSION["pedido_concreto"];
...
<body bgcolor='#ffffff'
    ...
    <table cellspacing='6' cellpadding='6' style='width: 100%; background-color: #ececec;'>
        <tr>
            <td style='width: 50%;'>
                <img width='80'
    ...
    <table cellspacing='6' cellpadding='6'  style='width: 100%; background-color: #ffffff;'>
        ...
        <tr>
            <td style='width: 50%; font-weight: bolder;'>GRADO: </td>
    ...
    <table cellspacing='6' cellpadding='6'
        style='width: 100%; background-color: #ffffff; border-top: 1px solid #ececec '>
          <tr>
     ...
     <table cellspacing='6' cellpadding='6'
      ...
      <table cellspacing='6' cellpadding='6' style='width: 100%; background-color: #ffffff; border-top: 1px solid #ececec '>
          <tr>
...
$mail->Username = 'librodereclamaciones@trilce.edu.pe';

//Password to use for SMTP authentication
$mail->Password = 'L1broR3cl4';
