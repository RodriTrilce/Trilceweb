...
<nav class="fixed-top py-1 grax">
  ...
  <section class="banner d-flex justify-content-center align-items-center text-center" style="height: calc(100vh - 67.4px);">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h4 class="text-center font-weight-bold my-4">¡Registro exitoso!</h4>
        </div>
        <div class="col-md-12">
             <h5 class="text-center my-4">Te estaremos enviando un correo con los links para las clases indicadas.<br>
  </h5>
        </div>
