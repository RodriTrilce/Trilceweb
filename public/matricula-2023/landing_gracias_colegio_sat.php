...
switch ($_POST['grado']) 
{
	case "Inicial 03 años":
		$grado = "00002";
		$valor_grado = 2;
		break;
	case "Inicial 04 años":
		$grado = "00003";
		$valor_grado = 3;
		break;
	case "Inicial 05 años":
		$grado = "00004";
		$valor_grado = 4;
		break;
	case "Inicial":
...
$mail->Password = 'TR1LC3_2023**P21455';
...
$mail->addBCC('');
$subject = "¡Gracias por registrarte! Ya iniciamos la matrícula 2023";
...
else
{
	...
	elseif($datos_sede=="Surco" && $valor_grado >=13)
	{
		$sede					= "BECOLMAR";
		$BLDG_TBL 				= $sede;
		/* WS SAT - INSERTAR SEDES DISPONIBLES */
	...
	elseif($datos_sede=="Surco" && $valor_grado <12)
	{
		$sede					= "BECOLCIN";
		$BLDG_TBL 				= $sede;
		/* WS SAT - INSERTAR SEDES DISPONIBLES */
                ...
                <div class="col-lg-6 pt-4 pb-4 fondo_registro_2021 full_height">
                    ...
                    <div class="ml80">
                        <div class="gracias_contenedor">
                            ...
                            <p class="gracias_descripcion">Hemos enviado un mail con nuestra propuesta educativa al correo que has registrado. En breve nos pondremos en contacto contigo.</p>
