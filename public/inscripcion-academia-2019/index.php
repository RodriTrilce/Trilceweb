                        ...
                        <form id="inscripcion_academia_trilce">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb10">
                                    ...
                                    <input id="dni" name="dni" type="text" class="form-control" placeholder="DNI" required="" minlength="8" maxlength="8" autocomplete="off">
                                    <div class="alert_box message_box_dni"> </div>
                                ...
                                <div class="col-md-12 mb10  invisible" style="height: 1px;">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="medio" id="medio" value="whatsapp"> 
                                                    <span class="custom-control-description text-white-gray">WhatsApp</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="medio" id="medio" value="email" checked>
                                                    <span class="custom-control-description text-white-gray">E-mail</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="medio" id="medio" value="telefono">
                                                    <span class="custom-control-description text-white-gray">Tel&#233;fono</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <input id="submit" value="Enviar"  type="submit" name="submit" class="btn btn-primary btn-block">
