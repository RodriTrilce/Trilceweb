...
$mail->IsHTML(true);
$mail->send(); // Puedes validar si falla, pero ya no es obligatorio mostrar mensaje
...
$sql = "INSERT INTO lista_espera_api (
  nombres_apellidos, nombres, apellido_paterno, apellido_materno, dni, correo_e, nro_telefono, sede, grado,
