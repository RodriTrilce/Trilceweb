        ...
        <div class="col-lg-12 pt-3 fondo_registro_2021 full_height pad160">
          ...
          <div class="row">
            <div class="col-lg-4">
              ...
              <p class="titulo_matricula">Realice la matrícula hoy y asegúrese de que sus hijos/as sean <b>alumnos mejor preparados.</b></p>
            </div>
            <div class="col-lg-4">
              <img src="images/nuevo_proceso.png" alt="Trilce Colegio" class="nuevo_proceso border_imagen">
              <div class="div_imagen">
                <h2 class="h1_matricula">Iniciar nuevo proceso</h2>
                <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1">¡Clic aquí!</button>
              </div>
            </div>
            <div class="col-lg-4">
              <img src="images/continuar_proceso.png" alt="Trilce Colegio" class="continuar_proceso border_imagen">
              <div class="div_imagen">
                <h2 class="h1_matricula">Continuar proceso</h2>
                <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1">¡Validar pago de matrícula!</button>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12">
              <p class="pie_matricula">© 2022 Trilce. Todos los derechos reservados.</p>
            </div>
          </div>
        </div>
      </div>
