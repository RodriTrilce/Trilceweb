...
<head>
    <meta charset="utf-8" />
    <title>Academia Trilce <?php echo date("Y"); ?> - Preparación ESCOLAR</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Formulario para el registro de Preparación ESCOLAR" />
    <meta name="keywords" content="Preparación ESCOLAR" />
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-6 pt-4 fondo_registro_2021 full_height">
            ...
            <div class="ml80">
              ...
              <p class="subtitulo_academia">Usted eligió: <b class="texto_preparacion">Preparación ESCOLAR</b></p>
                <form class="registration-form w_form" action="landing-gracias-escolar.php" method="post">
                  ...
                  <div class="form-group mb-2">
                    <input type="text" class="form-control fondo_blanco" id="celular" name="celular" placeholder="Número decelular" onkeypress="return isNumber(event)" onpaste="return false;" minlength="7" maxlength="12"required="required">
                  </div>
                  <div class="form-group mb-2">
                    <input type="email" class="form-control fondo_blanco" id="email" name="email" placeholder="Correoelectrónico" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required="required">
                  </div>
                  <div class="form-group mb-2">
                  ...
                  <a href="https://www.trilce.edu.pe/l/whatsapp-escolar" target="_blank" class="btn btn-primary btn-block texto_solicita vista_home_boton1" style="width: 296px; height:36px; background-color: #FF4E0E !important; border: 2px solid #fff !important; color: #fff !important;font-family: 'GRB'; font-size: 18px !important"><img src="images/w_b.svg" alt="Trilce Colegios" style="width:24px"> ¡Inscríbete por WhatsApp!</a>
                </form>
