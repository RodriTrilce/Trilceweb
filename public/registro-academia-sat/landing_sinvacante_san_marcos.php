            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height">
                    ...
                    <div class="ml80">
                        ...
                        <div class="w40 ">
                            <div class="row">
                                <p class="texto_sinvacante">Por el momento, no contamos con vacantes disponibles para el ciclo San Marcos. Te recomendamos las siguientes preparaciones:</p>
                            </div>
                        </div>
                        ...
                        <div class="w40 contenedor_ciclo">
                            <a href="landing_formulario_catolica.php">
                            <div class="row">
                                <div class="col-lg-5 col-xs-5 tar">
