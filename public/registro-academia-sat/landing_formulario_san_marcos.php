            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 pt-4 fondo_registro_2021 full_height">
                    ...
                    <div class="ml80">
                        ...
                        <p class="subtitulo_academia">Usted eligió: Preparación SAN MARCOS</p>
                        <form class="registration-form w_form" action="landing_gracias_san_marcos.php" method="post">
                            ...
                            <div class="form-group mb-2">
                                <textarea id="comentario" name="comentario" rows="3" cols="40" class="form-control fondo_blanco" placeholder="Comentario" style="border-radius: 20px;" required="required"></textarea>
                            </div>
                            <div class="form-group mb-2">
                                <input type="checkbox" name="acepta" required="required"> <span class="texto_acepta" style="color: #fff">He leido y acepto <a class="check-div-a>" id="myBtn" style="color: #fff;text-decoration: underline !important;font-family: 'NSB';cursor: pointer;">términos y condiciones.</b></a></span>
                            </div>
