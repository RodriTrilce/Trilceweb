            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="row">
						...
						<div class="col-md-4 caja_preparacion">
							<button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_uni_semestral.php'">Semestral</button>
                        </div>
						<div class="col-md-4 caja_preparacion">
							<button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" style="color: #fff !important; background-color: #FF4F00 !important;" onclick="window.location.href='ciclo_uni_escolar.php'">Escolar</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row">
                                ...
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-10 fs13">
                                            <h1 class="mt-2 titulo_video2">Ciclo Escolar UNI</h1>
                                            ...
                                            <p>Horario de clases: Lunes a sábado de 4:00 p. m. a 8:00 p. m.* 
                        ...
                        <div class="col-lg-6 mx-auto text-center">
                            <img src="images/ciclo_escolar_uni.png" class="foto_width">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                ...
                                <p class="mt-3 parrafo_1">
                                    Estudiantes que cursan 5.º año de secundaria interesados en postular en la modalidad examen escolar que ofrece esta casa de estudios.
                                </p>
                                <img src="images/uni_escolar_imagen.png" class="foto_width">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="mt-3 parrafo_1">
                                    El plan de estudios se encuentra diseñado con los cursos y temas que la Universidad Nacional de Ingeniería ha considerado en sus exámenes de admisión para escolares, sumado a nuestra plana de docente con experiencia en la preparación para el ingreso a esta casa de estudios.
                                </p>
                                <h1 class="mt-5 titulo_video">Duración</h1>
                                <p class="mt-3 parrafo_1">
                                    20 semanas, considerando el primer inicio 15 de marzo de 2021.
                                </p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4 video_fondo">
                    <div class="row">
                        <div class="col-lg-6 foto_video_uni_escolar mx-auto text-center">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
