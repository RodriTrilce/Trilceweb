                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 caja_preparacion">
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_catolica.php'">Semestral</button>
                        </div>
                        <div class="col-md-4 caja_preparacion">
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_catolica_primera_opcion.php'" style="color: #fff !important; background-color: #FF4F00 !important;">Primera Opción</button>
                        </div>
                        <div class="col-md-2">
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3">
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-12 fs13">
                                            <h1 class="mt-2 titulo_video3">Ciclo Primera Opción Católica</h1>
                                            <div style="background-color: #fff; padding: 20px" class="mb-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 fs13">
                                                        ...
                                                        <b>S/ 180</b>
                                                        <br><br>
                                                        <b style="color: #FF4F00">Sin Vacantes</b>
                                                    </div>
                                                </div>
                                            </div>
                                            <p>Horario de clases: Lunes a viernes de 4:00 p. m. a 8:00 p. m.* 
                        ...
                        <div class="col-lg-6 mx-auto text-center" class="foto_width">
                            <img src="images/ciclo_pop_pucp.png" class="foto_width">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                ...
                                <p class="mt-3 parrafo_1">
                                    Estudiantes que cursan el 5.º año de secundaria y desean ingresar a la universidad en un próximo examen de admisión.
                                </p>
                                <img src="images/pucp_pop_imagen.png">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="mt-3 parrafo_1">
                                    16 semanas, considerando el primer inicio 29 de marzo de 2021.
                                </p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4 video_fondo">
                    <div class="row">
                        <div class="col-lg-6 foto_video_pucp_pop mx-auto text-center">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
