        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-4 col-lg-4">
                    <h2 class="mb-4 texto_slider" >Preparación<br>Ciclos Católica</h2>
                    <button type="submit" class="btn btn-primary2 btn-block texto_solicita vista_home_boton1">Semestral: Incorporaciones</button>
                    <button type="submit" class="btn btn-primary2 btn-block texto_solicita vista_home_boton1">POP: Incorporaciones</button>
                </div>
                <div class="col-xl-4 col-lg-4">
                    <img src="images/ciclos_pucp/foto_slider_pucp1.png" alt="" class="vista_home_foto">
                </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 caja_preparacion">
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_catolica.php'" style="color: #fff !important; background-color: #FF4F00 !important;">Semestral</button>
                        </div>
                        <div class="col-md-4 caja_preparacion">
                            <button type="submit" class="btn btn-primary btn-block texto_solicita vista_home_boton1" onclick="window.location.href='ciclo_catolica_primera_opcion.php'">Primera Opción</button>
                        </div>
                        <div class="col-md-2">
                        </div>
                    </div>
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row">
                                ...
                                <p class="mt-3 parrafo_1">
                                    <div class="row">
                                        <div class="col-lg-10 fs13">
                                            <h1 class="mt-2 titulo_video3">Ciclo Semestral Católica</h1>
                                            <div style="background-color: #fff; padding: 20px" class="mb-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 fs13">
                                                        <span></span> <b>(Incorporaciones)</b>
                                                        <br><br>
                                                        <span>24 de julio de 2021</span>
                                                        <br><br>
                                                        <span>Mañana</span>
                                                        <br><br>
                                                        <b>S/ 220</b>
                                            ...
                                            <p>Horario de clases: Lunes a viernes de 8:00 a. m. a 1:00 p. m.* 
                        ...
                        <div class="col-lg-6 mx-auto text-center">
                            <img src="images/ciclo_semestral_pucp.png" class="foto_width">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-3" style="padding-bottom: 0px !important">
                                ...
                                <p class="mt-3 parrafo_1">
                                    Estudiantes que acabaron 5.º año de secundaria y desean ingresar a la universidad en un próximo examen de admisión.
                                </p>
                                <img src="images/pucp_anual_imagen.png" class="foto_width">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                                ...
                                <p class="mt-3 parrafo_1">
                                    El plan de estudios se encuentra diseñado con los cursos y temas que la Universidad Católica considera en sus exámenes de admisión, sumado a nuestra plana docente con experiencia en la preparación para el ingreso a esta casa de estudios.
                                </p>
                                <h1 class="mt-5 titulo_video">Duración</h1>
                                <p class="mt-3 parrafo_1">
                                    21 semanas, considerando el primer inicio 1 de marzo de 2021.
                                </p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4 mb-4 video_fondo">
                    <div class="row">
                        <div class="col-lg-6 foto_video_pucp mx-auto text-center">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class=" text-center p-4">
                                ...
                                <p class="text-muted mb-0 font-size-12 wc-subtitle mt-4 contenido1_opcion">Simulacros tipo admisión (2 en el ciclo).</p>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class=" text-center p-4">
