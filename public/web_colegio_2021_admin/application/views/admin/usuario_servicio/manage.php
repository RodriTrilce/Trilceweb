   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>admin/usuario_servicio/add" class="btn btn-info">ADD NEW</a>
            <div class="form-group pull-right">
               <a href="<?php echo $csvlink; ?>" class="btn btn-info">CSV</a>
               <a href="<?php echo $pdflink; ?>" class="btn btn-info">PDF</a>
            </div>
            <form method="GET" action="<?php echo base_url().'admin/usuario_servicio/index'; ?>" class="form-inline ibox-content">
               <div class="form-group">
                  <select name="searchBy" class="form-control">
                  <option value="usuario.usuario" <?php echo $searchBy=="usuario.usuario"?'selected="selected"':""; ?>>Id_usuario</option><option value="servicio.servicio" <?php echo $searchBy=="servicio.servicio"?'selected="selected"':""; ?>>Id_servicio</option>
                  </select>
               </div>
               <div class="form-group">
               ...
               <tbody>
                  ...
                  <?php 
                     foreach ($results as $key => $value) {
                      ...
                      ?>
                  <tr  id="hide<?php echo $value->id_usuario_servicio; ?>" >
                  <th><input name='input' id='del' onclick="callme('show')"  type='checkbox' class='del' value='<?php echo $value->id_usuario_servicio; ?>'/></th>

                              

            <th><?php if(!empty($value->id_usuario_servicio)){ echo $count; $count++; }?></th><th><?php if(!empty($value->id_usuario)){ echo $value->id_usuario; }?></th>

                <th><?php if(!empty($value->id_servicio)){ echo $value->id_servicio; }?></th>

                <th class="action-width">

		   <a href="<?php echo base_url()?>admin/usuario_servicio/view/<?php echo $value->id_usuario_servicio; ?>" title="View">

            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>

           </a>

           <a href="<?php echo base_url()?>admin/usuario_servicio/edit/<?php echo $value->id_usuario_servicio; ?>" title="Edit">

            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>

           </a>

           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id_usuario_servicio; ?>','usuario_servicio');">
...
<script type="text/javascript">
   ...
   $.ajax({
     type:"POST",
     url:'<?php echo base_url()."admin/usuario_servicio/deleteAll"; ?>',
     data:{
       allIds : ids,
