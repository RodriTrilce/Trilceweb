...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo1",html_entity_decode($matricula_uni_anual->titulo1)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo2",html_entity_decode($matricula_uni_anual->titulo2)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("enlace",html_entity_decode($matricula_uni_anual->enlace)); ?>"
...
<!-- Enlace End -->
    ...
    <div class="form-group">
      ...
      value="<?php if (isset($foto) && $foto!=""){echo $foto; }?>" />  
        ...
        <?php if (isset($matricula_uni_anual->foto) && $matricula_uni_anual->foto!=""){?>

            <br>

  <img src="<?php echo $this->config->item("photo_url");?><?php echo $matricula_uni_anual->foto; ?>" alt="pic" width="50" height="50" />
