   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="table table-responsive">
            ...
            <th><?php if(!empty($value->id)){ echo $count; $count++; }?></th><th><?php if(!empty($value->name)){ ?> 

                        <img src="<?php echo $this->config->item('photo_url');?><?php echo $value->name; ?>" alt="pic" width="50" height="50" />
