...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nombres_apellidos",html_entity_decode($lista_espera->nombres_apellidos)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nombres",html_entity_decode($lista_espera->nombres)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("apellido_paterno",html_entity_decode($lista_espera->apellido_paterno)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("apellido_materno",html_entity_decode($lista_espera->apellido_materno)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("dni",html_entity_decode($lista_espera->dni)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("email",html_entity_decode($lista_espera->email)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("telefono",html_entity_decode($lista_espera->telefono)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("sede",html_entity_decode($lista_espera->sede)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("grado",html_entity_decode($lista_espera->grado)); ?>"
...
<!-- Grado End -->
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="fecha_registro" id="fecha_registro" value="<?php echo set_value("fecha_registro",$lista_espera->fecha_registro); ?>"/> 
