...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("ciclo",html_entity_decode($lista_espera_academia->ciclo)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("turno",html_entity_decode($lista_espera_academia->turno)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("dni",html_entity_decode($lista_espera_academia->dni)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nombres_apellidos",html_entity_decode($lista_espera_academia->nombres_apellidos)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("telefono",html_entity_decode($lista_espera_academia->telefono)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("email",html_entity_decode($lista_espera_academia->email)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("comentario",html_entity_decode($lista_espera_academia->comentario)); ?>"
...
<!-- Comentario End -->
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="fecha_registro" id="fecha_registro" value="<?php echo set_value("fecha_registro",$lista_espera_academia->fecha_registro); ?>"/> 
