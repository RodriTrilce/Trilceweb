...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="galeria" name="galeria"><?php echo set_value("galeria",html_entity_decode($galeria->galeria)); ?></textarea>
...
<!-- Galeria End -->
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_foto_cover" 

      value="<?php if (isset($foto_cover) && $foto_cover!=""){echo $foto_cover; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $galeria->foto_cover; ?>" alt="pic" width="50" height="50" />
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_foto1" 

      value="<?php if (isset($foto1) && $foto1!=""){echo $foto1; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $galeria->foto1; ?>" alt="pic" width="50" height="50" />
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_foto2" 

      value="<?php if (isset($foto2) && $foto2!=""){echo $foto2; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $galeria->foto2; ?>" alt="pic" width="50" height="50" />
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_foto3" 

      value="<?php if (isset($foto3) && $foto3!=""){echo $foto3; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $galeria->foto3; ?>" alt="pic" width="50" height="50" />
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_foto4" 

      value="<?php if (isset($foto4) && $foto4!=""){echo $foto4; }?>" />  
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $galeria->foto4; ?>" alt="pic" width="50" height="50" />
	...
	<div class="form-group">
      ...
      foreach($servicio as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_servicio; ?>" <?php echo $value->id_servicio==$galeria->id_servicio?'selected="selected"':""; ?>>
