...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("estado",html_entity_decode($estado->estado)); ?>"
...
<!-- Estado End -->
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="fecha_registro" id="fecha_registro" value="<?php echo set_value("fecha_registro",$estado->fecha_registro); ?>"/> 
