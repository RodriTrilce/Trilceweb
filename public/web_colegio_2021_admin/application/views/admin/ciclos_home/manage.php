   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>admin/ciclos_home/add" class="btn btn-info">ADD NEW</a>
            <div class="form-group pull-right">
               <a href="<?php echo $csvlink; ?>" class="btn btn-info">CSV</a>
               <a href="<?php echo $pdflink; ?>" class="btn btn-info">PDF</a>
            </div>
            <form method="GET" action="<?php echo base_url().'admin/ciclos_home/index'; ?>" class="form-inline ibox-content">
               <div class="form-group">
                  <select name="searchBy" class="form-control">
                  <option value="imagen" <?php echo $searchBy=="imagen"?'selected="selected"':""; ?>>Imagen</option><option value="titulo" <?php echo $searchBy=="titulo"?'selected="selected"':""; ?>>Titulo</option><option value="subtitulo" <?php echo $searchBy=="subtitulo"?'selected="selected"':""; ?>>Subtitulo</option><option value="enlace" <?php echo $searchBy=="enlace"?'selected="selected"':""; ?>>Enlace</option><option value="estado.estado" <?php echo $searchBy=="estado.estado"?'selected="selected"':""; ?>>Id_estado</option><option value="fecha_registro" <?php echo $searchBy=="fecha_registro"?'selected="selected"':""; ?>>Fecha_registro</option>
                  </select>
               </div>
               <div class="form-group">
         ...
         <div class="table table-responsive">
            ...
            <th><?php if(!empty($value->id)){ echo $count; $count++; }?></th><th><?php if(!empty($value->imagen)){ ?> 
		   ...
		   <a href="<?php echo base_url()?>admin/ciclos_home/view/<?php echo $value->id; ?>" title="View">

            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>

           </a>

           <a href="<?php echo base_url()?>admin/ciclos_home/edit/<?php echo $value->id; ?>" title="Edit">

            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>

           </a>

           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id; ?>','ciclos_home');">
...
<script type="text/javascript">
   ...
   $.ajax({
     type:"POST",
     url:'<?php echo base_url()."admin/ciclos_home/deleteAll"; ?>',
     data:{
       allIds : ids,
