...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-10">
      <h2>Contacto_colegio</h2>
      <ol class="breadcrumb">
         <li>
            <a href="<?php echo base_url().'admin/'?>">Dashboard</a>
         </li>
         <li class="active">
            <strong>Contacto_colegio</strong>
         </li>
      </ol>
   </div>
   <div class="col-lg-2">
   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>admin/contacto_colegio/add" class="btn btn-info">ADD NEW</a>
            <div class="form-group pull-right">
               <a href="<?php echo $csvlink; ?>" class="btn btn-info">CSV</a>
               <a href="<?php echo $pdflink; ?>" class="btn btn-info">PDF</a>
            </div>
            <form method="GET" action="<?php echo base_url().'admin/contacto_colegio/index'; ?>" class="form-inline ibox-content">
               <div class="form-group">
                  <select name="searchBy" class="form-control">
                  <option value="nombres_apellidos" <?php echo $searchBy=="nombres_apellidos"?'selected="selected"':""; ?>>Nombres_apellidos</option><option value="correo" <?php echo $searchBy=="correo"?'selected="selected"':""; ?>>Correo</option><option value="telefono" <?php echo $searchBy=="telefono"?'selected="selected"':""; ?>>Telefono</option><option value="consulta" <?php echo $searchBy=="consulta"?'selected="selected"':""; ?>>Consulta</option><option value="fecha_registro" <?php echo $searchBy=="fecha_registro"?'selected="selected"':""; ?>>Fecha_registro</option>
                  </select>
               </div>
               <div class="form-group">
         ...
         <div class="table table-responsive">
            <table class="table table-striped table-bordered table-hover Tax" >
               <thead>
				...
				<?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="correo"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>

				<th> <a href="<?php echo $fields_links["correo"]; ?>" class="link_css"> Correo <?php echo $symbol ?></a></th>
				...
				<?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="consulta"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>

				<th> <a href="<?php echo $fields_links["consulta"]; ?>" class="link_css"> Consulta <?php echo $symbol ?></a></th>
            ...
            <th><?php if(!empty($value->id)){ echo $count; $count++; }?></th><th><?php if(!empty($value->nombres_apellidos)){ echo $value->nombres_apellidos; }?></th>
                ...
                <th><?php if(!empty($value->correo)){ echo $value->correo; }?></th>

                <th><?php if(!empty($value->telefono)){ echo $value->telefono; }?></th>

                <th><?php if(!empty($value->consulta)){ echo $value->consulta; }?></th>

                <th><?php if(!empty($value->fecha_registro)){ echo $value->fecha_registro; }?></th>

                <th class="action-width">

		   <a href="<?php echo base_url()?>admin/contacto_colegio/view/<?php echo $value->id; ?>" title="View">

            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>

           </a>

           <a href="<?php echo base_url()?>admin/contacto_colegio/edit/<?php echo $value->id; ?>" title="Edit">

            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>

           </a>

           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id; ?>','contacto_colegio');">
...
<script type="text/javascript">
   ...
   $.ajax({
     type:"POST",
     url:'<?php echo base_url()."admin/contacto_colegio/deleteAll"; ?>',
     data:{
       allIds : ids,
