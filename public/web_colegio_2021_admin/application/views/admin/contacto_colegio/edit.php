...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nombres_apellidos",html_entity_decode($contacto_colegio->nombres_apellidos)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("correo",html_entity_decode($contacto_colegio->correo)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("telefono",html_entity_decode($contacto_colegio->telefono)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="consulta" name="consulta"><?php echo set_value("consulta",html_entity_decode($contacto_colegio->consulta)); ?></textarea>
...
<!-- Consulta End -->
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="fecha_registro" id="fecha_registro" value="<?php echo set_value("fecha_registro",$contacto_colegio->fecha_registro); ?>"/> 
