...
<div class="row">
  <div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_icono" 

      value="<?php if (isset($icono) && $icono!=""){echo $icono; }?>" />  

        <?php if(isset($icono_err) && !empty($icono_err)) 

        {foreach($icono_err as $key => $error)
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("titulo",html_entity_decode($banner_home->titulo)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("subtitulo",html_entity_decode($banner_home->subtitulo)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("formulario",html_entity_decode($banner_home->formulario)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("orden",html_entity_decode($banner_home->orden)); ?>"
  ...
  <div class="col-sm-5" >
    ...
    <?php echo form_error("orden","<span class='label label-danger'>","</span>")?>
...
<!-- Orden End -->
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" name="fecha_registro" id="fecha_registro" value="<?php echo set_value("fecha_registro",$banner_home->fecha_registro); ?>"/> 
	...
	<div class="form-group">
      ...
      foreach($estado as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$banner_home->id_estado?'selected="selected"':""; ?>>
