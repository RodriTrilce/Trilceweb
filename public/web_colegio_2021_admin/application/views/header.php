    ...
    <body>
        ...
        <script>
            ...
            function delete_return()
            {
                ...
                <li <?php if($contr == 'lista_espera'){?>class="active "<?php } ?>  >
                    <a href="javascript:;"><i class="fa fa-users"></i><span class="title">Lista de Espera</span>
                        <?php if($contr == 'lista_espera'){?><span class="selected"></span><?php } ?>
                      <span class="arrow <?php if($contr == 'lista_espera'){?>open<?php } ?>"></span>
                    </a>
                    <ul class="nav nav-second-level">
                      <li <?php if($contrnew == 'lista_espera/'){?>class="active"<?php } ?>>
                        <a href="<?php echo base_url()?>admin/lista_espera/index"><i class="fa fa-gear"></i>Gestionar</a>
                      </li>                       
                    </ul>
                </li>
                <li <?php if($contr == 'lista_espera_2023'){?>class="active "<?php } ?>  >
                    <a href="javascript:;"><i class="fa fa-users"></i><span class="title">Lista de Espera 2023</span>
                        <?php if($contr == 'lista_espera_2023'){?><span class="selected"></span><?php } ?>
                      <span class="arrow <?php if($contr == 'lista_espera_2023'){?>open<?php } ?>"></span>
                    </a>
                    <ul class="nav nav-second-level">
                      <li <?php if($contrnew == 'lista_espera_2023/'){?>class="active"<?php } ?>>
                        <a href="<?php echo base_url()?>admin/lista_espera_2023/index"><i class="fa fa-gear"></i>Gestionar</a>
                      </li>                       
                    </ul>
                </li>
                <!--  EO : Lista_espera -->
				...
				<!-- BO : Lista_vacaciones_utiles -->

                <li <?php if($contr == 'lista_vacaciones_utiles'){?>class="active "<?php } ?>  >

                    <a href="javascript:;"><i class="fa fa-users"></i><span class="title">Vacaciones Útiles 2022</span>

                        <?php if($contr == 'lista_vacaciones_utiles'){?><span class="selected"></span><?php } ?>

                      <span class="arrow <?php if($contr == 'lista_vacaciones_utiles'){?>open<?php } ?>"></span>

                    </a>

                    <ul class="nav nav-second-level">
                      <li <?php if($contrnew == 'lista_vacaciones_utiles/'){?>class="active"<?php } ?>>

                        <a href="<?php echo base_url()?>admin/lista_vacaciones_utiles/index"><i class="fa fa-gear"></i>Gestionar</a>
				...
				<!-- BO : Contacto_academia -->

                <li <?php if($contr == 'contacto_academia'){?>class="active "<?php } ?>  >

                    <a href="javascript:;"><i class="fa fa-users"></i><span class="title">Contacto Academia</span>

                        <?php if($contr == 'contacto_academia'){?><span class="selected"></span><?php } ?>

                      <span class="arrow <?php if($contr == 'contacto_academia'){?>open<?php } ?>"></span>

                    </a>

                    <ul class="nav nav-second-level">

                      <li <?php if($contrnew == 'contacto_academia/'){?>class="active"<?php } ?>>

                        <a href="<?php echo base_url()?>admin/contacto_academia/index"><i class="fa fa-gear"></i>Gestionar</a>
                ...
                <li <?php if($contr == 'contacto_colegio'){?>class="active "<?php } ?>  >

                    <a href="javascript:;"><i class="fa fa-users"></i><span class="title">Contacto Colegio</span>

                        <?php if($contr == 'contacto_colegio'){?><span class="selected"></span><?php } ?>

                      <span class="arrow <?php if($contr == 'contacto_colegio'){?>open<?php } ?>"></span>

                    </a>

                    <ul class="nav nav-second-level">

                      <li <?php if($contrnew == 'contacto_colegio/'){?>class="active"<?php } ?>>

                        <a href="<?php echo base_url()?>admin/contacto_colegio/index"><i class="fa fa-gear"></i>Gestionar</a>
