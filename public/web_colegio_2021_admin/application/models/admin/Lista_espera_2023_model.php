...
class Lista_espera_2023_model extends CI_Model
{
    public $v_fields=array('nombres_apellidos', 'nombres', 'apellido_paterno', 'apellido_materno', 'dni', 'email', 'telefono', 'sede', 'grado', 'fecha_registro');
