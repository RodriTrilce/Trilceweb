...

{
    ...
    public $v_fields=array('fecha_inicio', 'fecha_fin', 'hora_inicio', 'hora_fin', 'usuario.usuario', 'usuario.usuario', 'total', 'medio_pago.medio_pago', 'estado.estado');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , cliente.usuario as id_usuario  , profesional.usuario as idprofesional  , medio_pago.medio_pago as id_medio_pago  , estado.estado as id_estado ");

        $this->db->from($table);

         $this->db->join("usuario AS cliente", "reserva.id_usuario = cliente.id_usuario", "left");  
         $this->db->join("usuario AS profesional", "reserva.idprofesional = profesional.id_usuario", "left");  
         $this->db->join("medio_pago", "reserva.id_medio_pago = medio_pago.id_medio_pago", "left");  
         $this->db->join("estado", "reserva.id_estado = estado.id_estado", "left");     
    ...
    function getRow($table, $id) {
        ...
        $query = $this->db->get_where($table, array('id_reserva' => $id));
